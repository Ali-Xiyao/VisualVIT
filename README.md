...
R51 随后在新的 500 人、相同 2,500-train、相同 exact-64、projector、prompt
和 frozen Qwen 下完成三 Seed matched system comparison。PRTA/TILA/B2 mean
Macro-F1 为 **0.3848/0.3166/0.2551**；PRTA−TILA +6.82 pp、CI
`[+3.51,+10.08]`，PRTA−B2 +12.97 pp、CI `[+9.73,+16.29]`。

R52 又在相同 500 人、相同 2,500-train、相同 exact-64 cache 与完全相同
...
2. [PRTA-CXR 论文方法、架构与 Pipeline 详解](docs/PRTA_CXR_PAPER_METHOD_ARCHITECTURE_PIPELINE_CN.md)
3. [R51 exact-64 frozen-Qwen matched-interface 结果](reports/PRTA_GEN_R51_MATCHED_INTERFACE_RESULT_CN.md)
4. [R52 统一 exact-64 直接分类头结果](reports/PRTA_GEN_R52_MATCHED_DIRECT_HEAD_RESULT_CN.md)
5. [R50 文献方法复现与强基线结果](reports/PRTA_GEN_R50_LITERATURE_METHOD_REPRODUCTION_RESULT_CN.md)
6. [R49 统一三系统结果](reports/PRTA_GEN_R49_UNIFIED_THREE_WAY_RESULT_CN.md)
7. [R45 CDEB discovery 终局报告](reports/PRTA_GEN_R45_CDEB_DISCOVERY_RESULT_CN.md)
8. [R44A 跨来源 silver SFT 终态报告](reports/PRTA_GEN_R44A_CROSS_SOURCE_SILVER_SFT_RESULT_CN.md)
9. [R44A failure case study 与 R45 方向选择](reports/PRTA_GEN_R44A_FAILURE_CASE_STUDY_CN.md)
10. [R41A Qwen SFT 终态报告](reports/PRTA_GEN_R41A_PROGRESSION_SFT_RESULT_CN.md)
11. [R41A 失败案例研究](reports/PRTA_GEN_R41A_FAILURE_CASE_STUDY_CN.md)
12. [R40C 内部泛化终态报告](reports/PRTA_GEN_R40C_STRUCTURED_GENERALIZATION_RESULT_CN.md)
13. [PRTA-Gen R40A.2/R40B.4 结构化路线终态报告](reports/PRTA_GEN_R40A2_R40B4_STRUCTURED_ROUTE_RESULT_CN.md)
14. [R40C preflight 与 roster receipt](reports/PRTA_GEN_R40C_STRUCTURED_GENERALIZATION_PREFLIGHT_CN.md)
15. [PRTA-Gen R40A 失败案例研究](reports/PRTA_GEN_R40A_FAILURE_CASE_STUDY_CN.md)
16. [R39 终局报告](reports/R39_FROZEN_VLM_TRANSFER_FINAL_CN.md)
17. [TIER-CXR-VLM 当前 Proposal](TIER_CXR_VLM_Next_Stage_Proposal_CN.md)
18. [结果表与实验登记](TIER_CXR_VLM_Empty_Result_Tables_CN.md)
19. [消融与对比实验缺口审计](docs/TIER_CXR_VLM_EXPERIMENT_GAP_AUDIT_CN.md)
