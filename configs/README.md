# Frozen configuration index

| Config | Role | Terminal boundary |
|---|---|---|
| `r37/prta_a6_formal_bundle_v1.json` | Original R37 A6 formal bundle | Historical R37 inversion STOP lineage |
