...
1. `PRTA_GEN_R50_LITERATURE_METHOD_REPRODUCTION_RESULT_CN.md`
2. `PRTA_GEN_R49_UNIFIED_THREE_WAY_RESULT_CN.md`
3. `PRTA_GEN_R48_FPRR_POOLED_INTERNAL_FINAL_CN.md`
4. `PRTA_GEN_R48_FPRR_CONFIRMATION_RESULT_CN.md`
5. `PRTA_GEN_R45_R48_CASE_STUDY_AND_RAW_B3_RESULT_CN.md`
6. `PRTA_GEN_R45_CDEB_DISCOVERY_RESULT_CN.md`
7. `PRTA_GEN_R44A_CROSS_SOURCE_SILVER_SFT_RESULT_CN.md`
8. `PRTA_GEN_R44A_FAILURE_CASE_STUDY_CN.md`
9. `PRTA_GEN_R41A_PROGRESSION_SFT_RESULT_CN.md`
10. `PRTA_GEN_R41A_FAILURE_CASE_STUDY_CN.md`
11. `PRTA_GEN_R41_R43_PREFLIGHT_CN.md`
12. `PRTA_GEN_R40C_STRUCTURED_GENERALIZATION_RESULT_CN.md`
13. `PRTA_GEN_R40A2_R40B4_STRUCTURED_ROUTE_RESULT_CN.md`
14. `PRTA_GEN_R40C_STRUCTURED_GENERALIZATION_PREFLIGHT_CN.md`
15. `PRTA_GEN_R40A_FAILURE_CASE_STUDY_CN.md`
16. `PRTA_GEN_R40A_INFORMATION_SUFFICIENCY_RESULT_CN.md`
17. `R39_FROZEN_VLM_TRANSFER_FINAL_CN.md`
18. `R37_1_PROPOSAL_AND_CASE_STUDY_CLOSURE_CN.md`
19. `R37_1_TWO_SEED_FRESH_HOLDOUT_RESULT.md`
20. `R37_INVERSION_FAILURE_CASE_STUDY.md`
21. `R37_FORMAL_BUNDLE_PREFLIGHT.md`
