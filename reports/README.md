...
1. `PRTA_GEN_R40A_INFORMATION_SUFFICIENCY_RESULT_CN.md`
2. `PRTA_GEN_R40A_FAILURE_CASE_STUDY_CN.md`
3. `R39_FROZEN_VLM_TRANSFER_FINAL_CN.md`
4. `R37_1_PROPOSAL_AND_CASE_STUDY_CLOSURE_CN.md`
5. `R37_1_TWO_SEED_FRESH_HOLDOUT_RESULT.md`
6. `R37_INVERSION_FAILURE_CASE_STUDY.md`
7. `R37_FORMAL_BUNDLE_PREFLIGHT.md`
...
`README.md`、`docs/PROJECT_STATUS_CN.md`、PRTA-Gen R40A STOP 报告和
R39 终局报告为准。
