# CAPES-CI QPTM R19 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R19_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R19_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R19. It is derived
from the exact frozen R18 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R19 implementation hashes,
materializer identity, and a final freeze record. Runtime code must read the
first JSON object directly and must not recursively merge R18.

R14, R16, R17, and R18 artifacts remain immutable forensic evidence. R19 neither repairs
nor retrospectively authorizes them. Before freeze it cannot satisfy a survival
gate, issue a certificate, create an output root, access data, or support a
method, server, or scientific inference.

## 2. Machine-readable complete frozen registry

```json
{
  "protocol_id": "CAPES_CI_QPTM_R19_2026_07_23",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r18_full_canonical_registry_including_complete_freeze_record_and_prefinalization_runner_mismatch_for_forensic_base_identity",
    "authority_state": "FROZEN_BEFORE_R18_REPRODUCTION"
  },
  ...
  "schema_versions": {
    "resolver": "r19_resolver_v1",
    "summary": "r19_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r19_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r19_initialization_evidence_v1",
    ...
    "reproduction": "r19_reproduction_certificate_v1",
    "failure": "r19_atomic_failure_v1",
    "freeze_record": "r19_freeze_record_v1",
    "dryrun_postrun_audit": "r19_dryrun_postrun_audit_v1",
    "smoke_authorization": "r19_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r19_smoke_postrun_audit_v1",
    "registered_authorization": "r19_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r19_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r19_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r19_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r19_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r19_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r19_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R19_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R19_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R19",
    "smoke_authorized": "AUTHORIZED_R19_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R19_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R19_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R19_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R19_",
    "technical_failure": "TECHNICAL_FAILURE_R19_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R19_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R19_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "062c880e1f825d265224590ab5bff9045506ff8dc9182d7d627645580938a2c8",
      ...
      "src/visualvit/r6_validation.py": "7b98bb0d35078da909d4eb653379c997f302529346ea771788658314252de8df",
      ...
      "tests/test_query_anchor_r4_runner.py": "71a1d3b3bac4cb5cad6faf4deeec5506f02b5624dd95255c5f6e9a7ce4658e91",
      ...
      "tests/test_r6_validation.py": "fa4a9f46b290beded59f61cf1142cd69d91e9425b72e67d9cc0a4448eeabb816",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r19_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R19_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r19_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "52032f733a5f167c6626f550ac5fd79d43b608f501ed87bf1e9c0365db8daec3",
    "implementation_observation_sha256": "f212c1219f384c8d4489c384068beaab65b4ae0781c0a37c87fa43c3b1ee79b2",
    "runner_sha256": "062c880e1f825d265224590ab5bff9045506ff8dc9182d7d627645580938a2c8",
    ...
    "runner_tests_sha256": "71a1d3b3bac4cb5cad6faf4deeec5506f02b5624dd95255c5f6e9a7ce4658e91",
    ...
    "semantic_validator_sha256": "7b98bb0d35078da909d4eb653379c997f302529346ea771788658314252de8df",
    "semantic_validator_tests_sha256": "fa4a9f46b290beded59f61cf1142cd69d91e9425b72e67d9cc0a4448eeabb816",
    ...
    "closed_manifest_sha256": "047976fc4eff2589df730817df221397f31893d7cc736bb229f34f0a0129b9b6",
    "canonical_registry_sha256": "3966c7d5843d253c85939b175cace6f43309bf595acf399e119f8ea008d9c8d3",
  ...
  "corrective_scope": {
    "r19_administrative_deltas": [
      "require_active_runner_to_be_natively_R19_before_finalization",
      "bind_reconstructible_final_frozen_protocol_nonself_projection_hash",
      "bind_canonical_registry_nonself_projection_hash",
      "bind_certificates_to_runner_full_live_source_manifest_hash"
    ],
    ...
    "r18_protocol_and_full_canonical_registry_pins_immutable": true,
    "r14_v5_frozen_validator_bundle_and_all_R14_pins_unchanged": true,
    "fresh_r19_phase_audit_certificate_claim_failure_and_reproduction_namespaces_only": true,
    "no_prior_auditor_test_or_prior_protocol_artifact_rewrite": true,
    "new_r19_auditor_and_r19_tests_allowed": true,
    "runner_change_limited_to_native_r19_authority_and_namespace_activation": true,
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r19_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r19_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r19_registered.py",
        "sha256": "9951a8b531ac40c06274aabb64de411b19af94a343b0b5e5e3bed0b873cc82d8",
    ...
    "authorization_root_relative": "artifacts/calibration/.r19_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r19_phase_authorizations/claims",
    "claim_schema_version": "r19_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R19_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r19_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r19_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r19_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R19_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R19_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r19_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r19_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r19_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r19_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r19_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r19_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r19_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r19_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r19_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R19_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R19_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r19_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r19_phase_authorizations/reproduction_authorization.json"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R19_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R19_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r19_r14_provenance_comparator_routing_v1",
  ...
  "r19_pre_finalization_runner_contract": {
    "required_before_finalizer_import_or_implementation_observation": true,
    "runner_must_natively_load_protocol_relative_path": "refine-logs/CALIBRATION_PROTOCOL_R19_2026-07-23.md",
    "runner_must_natively_expose_protocol_id": "CAPES_CI_QPTM_R19_2026_07_23",
    "runner_must_natively_expose_registry_object": true,
    "runner_must_natively_expose_r19_schema_and_run_namespaces": true,
  ...
  "r19_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R19_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R19_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R19_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R19_REPRODUCTION",
    ...
    "freeze_record_semantics": "r19_complete_nonself_final_protocol_projection_contract_v1",
    ...
    "native_runner_precondition_ref": "/r19_pre_finalization_runner_contract"
  }
}
```
...
R19 is frozen before independent reproduction: implementation hashes are frozen, `dry_run_authorized=false` remains unchanged, and freeze alone authorizes no execution. The PRE_FREEZE prohibition applied until this one-shot finalization completed. Independent reproduction remains gated by the exact registered audit, two child certificates, claims, and runner verification in this authority. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths remain unauthorized.

R19 makes four administrative corrections: (1) the active runner must already natively load the R19 candidate, R19 registry, and fresh R19 namespaces before the finalizer imports it or observes implementation state; (2) the freeze precheck binds the reconstructible exact-byte frozen-protocol projection with only the first registry's `freeze_record` replaced by JSON null, while certificate `protocol_sha256` still binds the exact final frozen file bytes; (3) the freeze precheck binds the canonical registry projection with only the top-level `freeze_record` removed, while certificate `registry_sha256` still binds the complete registry including its non-null freeze record; and (4) every phase certificate binds `source_manifest_sha256` to the runner's full live `_source_manifest()["sha256"]`, including the protocol and observed workspace imports, never to the freeze-only nonprotocol `closed_manifest_sha256`. The finalizer fails closed rather than retargeting or monkeypatching an R18-or-earlier runner.

## 4. Scientific invariance and forensic boundary

These are administrative integrity deltas only. R19 changes no scientific method, architecture, objective, fixture, threshold, seed, split, optimizer setting, registered step count, gate order, survival logic, formal boundary, claim flag, data contract, or two-child routing. The R16 failed audit, R17 incomplete freeze record, and R18 pre-finalization runner mismatch remain immutable forensic evidence and cannot authorize R19. Dataset/model downloads, real-image training, clinical claims, formal-test reveal, formal main experiments, and formal ablations remain HOLD or SEALED.

The frozen R14 v5 validator bundle and every R14 pin are retained unchanged. Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or terminated; R19 never authorizes `scancel 4161`.

## 5. R19 independent-reproduction boundary

R19 registers fresh R19 phase, audit, certificate, claim, failure, and reproduction namespaces only. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths are registered only for fail-closed rejection; none is authorized by R19.
