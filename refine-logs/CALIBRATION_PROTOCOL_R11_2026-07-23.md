# CAPES-CI QPTM R11 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R11_REPRODUCTION`  
Date: 2026-07-23  
Protocol ID: `CAPES_CI_QPTM_R11_2026_07_23`  
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R11 and authorizes only the
R11 independent reproduction defined by its phase-authorization contract. The
R10 protocol and its complete materialized registry are immutable base evidence.
The first JSON object below is the complete materialized effective R11 registry;
runtime code must read it directly and must not recursively merge R10.

R10 base authority is pinned by protocol SHA-256
`261863f52942f695ce996c1b692defd924e7876716cc9338a7fe82523dfedf89`
and full materialized registry SHA-256
`131484e3124579f31fe6d63241c29bfda13902bc12b9249610b12086ee51ec13`.

The R10 registered-local summary is eligible E1 engineering evidence. Its
summary SHA-256 is
`a337f81868f20aa94cc3c3b11d7f333e3729c68cdbe63f16fffedd1fb1b8b566`;
its status is
`PASS_R10_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION`. Independent
reproduction was not run, and this result is not scientific method evidence.

The R10 reproduction process-A pre-root phase-authorization failure is
immutable at SHA-256
`54b17e337181012e6145c54097c86a207588b7d8df7a78b158216e6793ad9672`. It
wrote no summary and created no target output root. It is ineligible for any
phase-survival, gate, method, threshold, server, or scientific inference. The
sole R11 correction is the one-shot reproduction-authorization certificate for
the registered absent child leaves; no retrospective authorization is permitted.

This frozen R11 authority registers the immutable R10 registered-local result
and its reproduction process-A pre-root technical failure. The failure remains
ineligible engineering or scientific evidence. The sole R11 implementation
change is an external strict registered-summary audit and a one-shot
reproduction-authorization certificate for the fixed R11 reproduction parent
and child leaves. All scientific contracts remain unchanged from R10.

## 2. Machine-readable complete frozen registry

```json
{
  "protocol_id": "CAPES_CI_QPTM_R11_2026_07_23",
  ...
  "base_dependency": {
    ...
    "protocol_sha256": "261863f52942f695ce996c1b692defd924e7876716cc9338a7fe82523dfedf89",
  ...
  "schema_versions": {
    "resolver": "r11_resolver_v1",
    "summary": "r11_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r11_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r11_initialization_evidence_v1",
    ...
    "reproduction": "r11_reproduction_certificate_v1",
    "failure": "r11_atomic_failure_v1",
    "freeze_record": "r11_freeze_record_v1",
    "dryrun_postrun_audit": "r11_dryrun_postrun_audit_v1",
    "smoke_authorization": "r11_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r11_smoke_postrun_audit_v1",
    "registered_authorization": "r11_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r11_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r11_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r11_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r11_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r11_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r11_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R11_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R11_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R11",
    "smoke_authorized": "AUTHORIZED_R11_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R11_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R11_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R10_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R11_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R11_",
    "technical_failure": "TECHNICAL_FAILURE_R11_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R11_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R11_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "888f4c0c597348aa063aa3bc4c5653b77df4bb7d3d75bc0bd9c40a58fd1e1383",
      "scripts/run_query_anchor_r4_reproduction.py": "4517203a4c5fadaf17ef9c79b3645b696eab92a53b706b0e9f8e7af0841bb5dc",
      ...
      "src/visualvit/r6_validation.py": "df04765b668300a84a8391299d673e20322a38280170a523ce01022fcdbaf1bc",
      ...
      "tests/test_query_anchor_r4_runner.py": "ac7a75f21f5f4cb2aa0fea1d7fb2bac075af9eb6129b167f13f8807da7aef55d",
      ...
      "tests/test_r6_reproduction.py": "d9ba5b5d9f022ea0aff53f02a9b97fa37a580e966b03d97391f266b20f68f2be",
      ...
      "tests/test_r6_validation.py": "d6f94de4819d83b5770ab11cc0c769aed0f380edac8ce23913afb8b8599ee220",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r11_pre_root_failures",
  ...
  "corrective_scope": {
    "sole_r11_execution_delta": "new_strictly_audited_one_shot_independent_reproduction_certificate_binds_only_the_r11_reproduction_parent_and_registered_process_a_process_b_children",
    "r10_frozen_protocol_and_evidence_immutable": true,
    "no_retrospective_r10_authorization": true,
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r11_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r11_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r11_registered.py",
        "sha256": "f432d2a056cc80b8230c2f40083884908039821003f88288a54c916e116798ce",
    ...
    "authorization_root_relative": "artifacts/calibration/.r11_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r11_phase_authorizations/claims",
    "claim_schema_version": "r11_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R11_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r11_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r11_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r11_phase_authorizations/r10_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R11_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R11_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r11_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r11_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r11_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r11_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r11_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r11_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r11_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r11_phase_authorizations/r10_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r11_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R11_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R11_INDEPENDENT_REPRODUCTION",
    ...
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R11_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R11_PHASE_AUTHORIZATION and create no affected child output root",
...
R11 independent reproduction may run only after freeze sets
`freeze_requirements.dry_run_authorized=true`. It additionally requires the
fixed-path `reproduction_authorization.json` certificate, which must bind the
final frozen protocol and full registry hashes to a passing external strict
audit of the R10 registered-local summary. The certificate is one-shot and
authorizes only the fixed R11 reproduction parent and named absent child leaves.
...
produce a pre-root `TECHNICAL_FAILURE_R11_PHASE_AUTHORIZATION`; no CLI or
environment bypass exists. Dry-run, smoke, registered-local, registered Slurm,
download, formal-data, and formal-test phases remain unauthorized.
...
hashes remain external evidence. The reproduction phase still requires the
fixed-path certificate defined by `phase_authorization_contract`.
...
R11 remains E1 synthetic engineering only. Dataset/model downloads, real-image
...
terminated. R11 never authorizes `scancel 4161`.


## R11 minimal execution correction

R11 registers the immutable R10 three-seed registered-local summary and the R10 reproduction process-A pre-root authorization failure. R11 changes no scientific contract. It introduces one external, strict registered-summary audit and one one-shot `reproduction_authorization` certificate. The certificate is fixed to the R11 reproduction parent and permits only the named absent child leaves `process_a` and `process_b`, with CPU, seeds `[17,29,43]`, and 500 steps. It cannot authorize any R10 root, formal data, data/model download, GPU/Slurm, or other output leaf.
