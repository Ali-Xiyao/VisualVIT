# CAPES-CI QPTM R7 Corrective Synthetic Engineering Protocol

Status: `FROZEN_BEFORE_R7_DRY_RUN`  
Date: 2026-07-22  
Protocol ID: `CAPES_CI_QPTM_R7_2026_07_22`  
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority and immutable R6 failure

This document is the sole frozen authority for R7. It inherits the method,
fixtures, estimands, thresholds, seeds, optimizer settings, gate order, access
order, counterfactuals, exact-64 interface, reproduction contract, and formal
claim boundaries from the exact R6 authority unless an explicit R7 corrective
override appears below.

Immutable base dependency:

- path: `refine-logs/CALIBRATION_PROTOCOL_R6_2026-07-22.md`;
- SHA-256: `fdc6fbf7e434b665f9b222d51185bddb3b6c5b5c129ab338041abd793d08974a`.

The first R6 dry-run remains immutable and is permanently ineligible despite
its stored `DRY_RUN_VALIDATED_R6` status. Its independent post-run audit is the
terminal authority for that attempt:

- invalid status: `INVALID_R6_DRY_RUN_POSTSERIALIZATION_VALIDATION`;
- summary: `artifacts/calibration/capes_ci_qptm_r6_dryrun_20260722_v1/summary.json`;
- summary SHA-256: `484486ed8c71524292979239fa953704e4a717fdad61c353ceeb58425ffe8bc0`;
- post-run audit: `artifacts/calibration/capes_ci_qptm_r6_dryrun_20260722_v1/postrun_audit.json`;
- audit file SHA-256: `5eed0dd7a75473fa126301c6bdf973ac4626794074a1dc8238ed0eaaa40d92c1`;
- audit self-hash: `e466fcdf764df8eecdf888995e1b2bafade18fd9b90c1cddfb45f21e5327df8a`;
- audit verdict: `FAIL_STRICT_POSTRUN_SEMANTIC_VALIDATION`.

R6 performed no training and accessed no registered or formal split. Its
failure is a serialization/validation-contract failure, not method evidence.
R7 must not rewrite, overwrite, delete, or retrospectively accept R6.

## 2. Single-variable corrective hypothesis

R6 generated the eight structural cases in the registered order and validated
them in memory. Production JSON publication used sorted object keys. Both R6
validators then incorrectly treated JSON object iteration order as semantic,
so the persisted report failed while its explicit ordered `required_case_ids`
array and all case contents remained intact.

R7 changes only the representation of the order invariant:

1. `required_case_ids` is the unique ordered authority.
2. `microcases` remains an exact-key JSON object whose iteration order is
   explicitly non-semantic.
3. `ordered_microcase_projection_sha256` is recomputed from the canonical JSON
   encoding of
   `[{"case_id": id, "evidence": microcases[id]} for id in required_case_ids]`.
4. Every case still undergoes exact-key, finite-number, gradient, feasibility,
   completion, plan, input-hash, and report-self-hash validation.
5. Missing, extra, duplicate, reordered required IDs, or a forged ordered
   projection fail closed.

This is not a threshold relaxation. No method, data, seed, optimization,
scientific metric, baseline, or gate changes in R7.

## 3. Machine-readable frozen registry

The following JSON object is normative. Its non-self-referential freeze
record binds the final implementation observation, governed source files,
tests, launcher, nonprotocol source projection, and registry projection.
Final protocol/full-manifest hashes remain external dry-run evidence.

```json
{
  "protocol_id": "CAPES_CI_QPTM_R7_2026_07_22",
  "authority_state": "FROZEN_BEFORE_R7_DRY_RUN",
  "evidence_class": "E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY",
  "base_dependency": {
    "path": "refine-logs/CALIBRATION_PROTOCOL_R6_2026-07-22.md",
    "sha256": "fdc6fbf7e434b665f9b222d51185bddb3b6c5b5c129ab338041abd793d08974a",
    "relationship": "immutable_r6_values_inherited_except_explicit_r7_overrides"
  },
  ...
  "schema_versions": {
    "resolver": "r7_resolver_v1",
    "summary": "r7_summary_v1",
    ...
    "independent_validator": "visualvit.r6-validation.v2",
    "data_access_ledger": "r6_split_access_ledger_v1",
    "exact64_ledger": "r6_exact64_call_ledger_v1",
    "reproduction": "r7_reproduction_certificate_v1",
    "failure": "r7_atomic_failure_v1",
    "freeze_record": "r7_freeze_record_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r7_dryrun_20260722_v1",
      "smoke": "capes_ci_qptm_r7_smoke_seed17_20260722_v1",
      "registered_local": "capes_ci_qptm_r7_registered_local_20260722_v1",
      "registered_slurm4161": "capes_ci_qptm_r7_registered_slurm4161_20260722_v1",
      "reproduction_local": "capes_ci_qptm_r7_reproduction_local_20260722_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r7_reproduction_slurm4161_20260722_v1"
    },
  ...
  "status_vocabulary": {
    ...
    "protocol_frozen": "FROZEN_BEFORE_R7_DRY_RUN",
    "invalid_ancestor": "INVALID_R6_DRY_RUN_POSTSERIALIZATION_VALIDATION",
    "dry_run_success": "DRY_RUN_VALIDATED_R7",
    "smoke_success": "SMOKE_COMPLETE_R7_NON_GATING",
    "primary_pending_reproduction": "PASS_R7_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R7_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R7_",
    "technical_failure": "TECHNICAL_FAILURE_R7_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R7_REPRODUCTION_LAUNCHER",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "5c559b7cc6e5dbbe93052f8fd808870ea205456893997da6bc8ed4f2975139c0",
      "scripts/run_query_anchor_r4_reproduction.py": "919792111186ac68a7eb3392c30b3e851547f9183a6885dcbe39378a9bb48002",
      ...
      "src/visualvit/r6_validation.py": "344eb9ee2789ecc5b88792ef2fd0c4bfdb1b37ee8f835b2d9459ffe971fb9e55",
      ...
      "tests/test_query_anchor_r4_runner.py": "6adf11d7dee894b27b02c424cc138aa8b976e0316d9813d6b80f648484040a46",
      ...
      "tests/test_r6_reproduction.py": "358ccf8ecda85f3c0ca31b633215558aaf518e86ec20e4688f270dfd0f765eb1",
      "tests/test_r6_runner_boundary.py": "00e75d7e1392868abc3df511de61aef2289b4a328478227204e08e47f50ed86d",
      "tests/test_r6_structural_audits.py": "525853077ac14c2de4b95074557fa29e4f47b490f1979fd5d4d1b0cb587b71a7",
      "tests/test_r6_validation.py": "36c73d74a480ee6dd7b30f271b20e4ac8a5ff85c6170c4605d646075100d25eb",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r7_pre_root_failures",
  ...
  "freeze_record": {
    "schema_version": "r7_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "0e49ff4315157be80c5179709b159137d73118065d0526c8955d90b8477e3df3",
    "implementation_observation_sha256": "45f326f8cc6b106cf4f4e402ac0c0d5d209b2060e9640aa55b8bd058b6a5c0df",
    "runner_sha256": "5c559b7cc6e5dbbe93052f8fd808870ea205456893997da6bc8ed4f2975139c0",
    "reproduction_launcher_sha256": "919792111186ac68a7eb3392c30b3e851547f9183a6885dcbe39378a9bb48002",
    ...
    "runner_tests_sha256": "6adf11d7dee894b27b02c424cc138aa8b976e0316d9813d6b80f648484040a46",
    ...
    "semantic_validator_sha256": "344eb9ee2789ecc5b88792ef2fd0c4bfdb1b37ee8f835b2d9459ffe971fb9e55",
    "semantic_validator_tests_sha256": "36c73d74a480ee6dd7b30f271b20e4ac8a5ff85c6170c4605d646075100d25eb",
    "boundary_tests_sha256": "00e75d7e1392868abc3df511de61aef2289b4a328478227204e08e47f50ed86d",
    "reproduction_tests_sha256": "358ccf8ecda85f3c0ca31b633215558aaf518e86ec20e4688f270dfd0f765eb1",
    ...
    "summary_roundtrip_tests_sha256": "00e75d7e1392868abc3df511de61aef2289b4a328478227204e08e47f50ed86d",
    "closed_manifest_sha256": "5a213594b2204894267ebecc2246c2361e32f8703ffe3a48cd5cba425a26b8d7",
    "canonical_registry_sha256": "6f48cb14c79024f34b4df58a9c5452713394b2422318416838d66787d3ed60fe"
  }
}
```

## 4. Post-serialization validation and atomic publication

R7 serializes the terminal summary exactly once as UTF-8 JSON with two-space
indentation, lexicographically sorted object keys, `allow_nan=false`, and one
terminal newline. Before publication, those exact bytes are parsed once and
the reparsed object must pass the runner-independent metric validator and all
embedded native structural/counterfactual validators. The already validated
bytes are then atomically published without a second serialization.

A post-serialization validation failure is technical failure evidence. It may
publish only a non-overwriting `failure.json`; it must not publish a successful
`summary.json` or return success.

## 5. Required R7 regression evidence

Before freeze, R7 requires:

- sorted-key structural report serialize/parse/native/independent PASS;
- exact dry-run terminal summary serialize/parse/strict/native PASS;
- missing, extra, duplicate, required-ID reorder, projection-hash tamper, case
  arithmetic tamper, and counterfactual tamper negatives;
- a main-process negative proving in-memory PASS cannot bypass reparsed FAIL;
- focused and full pytest, scoped Ruff/format, and py_compile PASS;
- three fresh implementation observations and three fresh Gate-0 processes
  with identical hashes and no false checks.

## 6. Gate order and execution boundary

The inherited order remains:

`resolution_freeze -> structural_input -> fixture_identifiability ->
transport_competence -> anti_equivalence -> mediator_recovery -> fair_baseline
-> exact64_bridge -> independent_reproduction`.

R7 authorizes only one fresh CPU dry-run in its new output root after final
freeze. A separate `r7_dryrun_postrun_audit_v1` must validate the persisted raw
summary bytes and return PASS before seed17 smoke is allowed. Smoke does not
authorize registered training. Every later phase stops at the first failed
gate.

## 7. Formal-data HOLD and allocation 4161

R7 remains E1 synthetic engineering only. Dataset/model downloads, real-image
...
terminated as cleanup after success, failure, or reproduction. R7 never
authorizes `scancel 4161`.
