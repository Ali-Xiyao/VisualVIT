# CAPES-CI QPTM R18 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R18_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R18_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R18. It is derived
from the exact frozen R16 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R18 implementation hashes,
materializer identity, and a final freeze record. Runtime code must read the
first JSON object directly and must not recursively merge R16.

R14 and all earlier artifacts remain immutable evidence. R18 neither repairs
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R18_2026_07_23",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r17_complete_canonical_registry_including_incomplete_freeze_record_for_forensic_base_identity",
    "authority_state": "FROZEN_BEFORE_R17_REPRODUCTION"
  },
  ...
  "schema_versions": {
    "resolver": "r18_resolver_v1",
    "summary": "r18_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r18_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r18_initialization_evidence_v1",
    ...
    "reproduction": "r18_reproduction_certificate_v1",
    "failure": "r18_atomic_failure_v1",
    "freeze_record": "r18_freeze_record_v1",
    "dryrun_postrun_audit": "r18_dryrun_postrun_audit_v1",
    "smoke_authorization": "r18_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r18_smoke_postrun_audit_v1",
    "registered_authorization": "r18_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r18_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r18_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r18_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r18_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r18_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r18_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R18_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R18_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R18",
    "smoke_authorized": "AUTHORIZED_R18_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R18_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R18_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R18_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R18_",
    "technical_failure": "TECHNICAL_FAILURE_R18_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R18_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R18_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "status_literals": {
      "protocol_candidate": "PRE_FREEZE_AWAITING_R17_IMPLEMENTATION_HASHES",
      "protocol_frozen": "FROZEN_BEFORE_R17_REPRODUCTION",
      "invalid_ancestor": "INVALID_R6_DRY_RUN_POSTSERIALIZATION_VALIDATION",
      "invalid_ancestor_smoke": "INELIGIBLE_UNAUTHORIZED_R8_SMOKE_TECHNICAL_FAILURE",
      "dry_run_success": "DRY_RUN_VALIDATED_R17",
      "smoke_authorized": "AUTHORIZED_R17_SMOKE",
      "smoke_success": "SMOKE_COMPLETE_R17_NON_GATING",
      "registered_local_authorized": "AUTHORIZED_R17_REGISTERED_LOCAL",
      "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
      "final_success": "PASS_R17_SYNTHETIC_ENGINEERING",
      "scientific_stop_prefix": "STOP_R17_",
      "technical_failure": "TECHNICAL_FAILURE_R17_UNHANDLED_EXCEPTION",
      "launcher_failure": "TECHNICAL_FAILURE_R17_REPRODUCTION_LAUNCHER",
      "phase_authorization_failure": "TECHNICAL_FAILURE_R17_PHASE_AUTHORIZATION",
      "formal_data": "HOLD",
      "formal_test": "SEALED"
    },
    "schema_versions": {
    ...
    "output_root_contract": {
      "phase_leaf_names": {
        "dry_run": "capes_ci_qptm_r17_dryrun_20260723_v1",
        "smoke": "capes_ci_qptm_r17_smoke_seed17_20260723_v1",
        "registered_local": "capes_ci_qptm_r17_registered_local_20260723_v1",
        "registered_slurm4161": "capes_ci_qptm_r17_registered_slurm4161_20260723_v1",
        "reproduction_local": "capes_ci_qptm_r17_reproduction_local_20260723_v1",
        "reproduction_slurm4161": "capes_ci_qptm_r17_reproduction_slurm4161_20260723_v1"
      },
      "reproduction_child_leaf_names": [
        "process_a",
        "process_b"
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "b98dd1ba2d185fcb89a0de6a0f65aeeb0e1d78fc112d64bfd58cbd0765737058",
      ...
      "src/visualvit/r6_validation.py": "44a3237350dbbb7c7e799925d1420dc6aeef9fdd6aa9b5797fb7b17a8776f124",
      ...
      "tests/test_query_anchor_r4_runner.py": "aabcdd9255fa488e7a0a26289f40e08d75f3e5f1398683ea3fb782f6529e1a8e",
      ...
      "tests/test_r6_validation.py": "5617d01c05359f3b20254dc3c10096b17acc304fc4be7233073af59639d79040",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r18_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R18_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r18_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "3bae0055a5fb3fa1f99df30ab4d70d27ce06b77f4d0add00246d8ba478d57c72",
    "implementation_observation_sha256": "522ec901677611bcbc6720a14485665eee5baa8d094392224525096a81a5ad0f",
    "runner_sha256": "b98dd1ba2d185fcb89a0de6a0f65aeeb0e1d78fc112d64bfd58cbd0765737058",
    ...
    "runner_tests_sha256": "aabcdd9255fa488e7a0a26289f40e08d75f3e5f1398683ea3fb782f6529e1a8e",
    ...
    "semantic_validator_sha256": "44a3237350dbbb7c7e799925d1420dc6aeef9fdd6aa9b5797fb7b17a8776f124",
    "semantic_validator_tests_sha256": "5617d01c05359f3b20254dc3c10096b17acc304fc4be7233073af59639d79040",
    ...
    "closed_manifest_sha256": "31b40bc10d101b9c8c6548fce900bc12e4aea59e0c25f20b5fa72f98f2a758f0",
    "canonical_registry_sha256": "4658f32166aa31572fdfac276094c44df553ce848506dad04d2b0bf06d87ee4c",
  ...
  "corrective_scope": {
    "sole_r18_semantic_delta": "complete_the_R18_freeze_record_with_the_exact_R16_nonself_registry_closed_manifest_and_implementation_observation_projections_while_preserving_R17_as_a_frozen_forensic_base",
    ...
    "r16_protocol_and_registry_projection_pins_immutable": true,
    "r14_v5_frozen_validator_bundle_and_all_R14_pins_unchanged": true,
    "fresh_r18_phase_audit_certificate_claim_failure_and_reproduction_namespaces_only": true,
    "no_runner_auditor_test_or_prior_protocol_artifact_rewrite": true,
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r18_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r18_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r18_registered.py",
        "sha256": "ab9789e806ff6364f6b050fcd1ca5ad15994b95c96a4fcda9a028a2e84849773",
    ...
    "authorization_root_relative": "artifacts/calibration/.r18_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r18_phase_authorizations/claims",
    "claim_schema_version": "r18_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R18_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r18_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r18_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r18_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R18_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R18_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r18_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r18_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r18_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r18_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r18_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r18_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r18_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r18_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r18_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R18_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R18_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r18_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r18_phase_authorizations/reproduction_authorization.json"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R18_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R18_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r18_r14_provenance_comparator_routing_v1",
  ...
  "r18_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R18_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R18_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R18_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R18_REPRODUCTION",
    ...
    "freeze_record_semantics": "r16_complete_nonself_projection_contract_v1"
  }
}
```
...
R18 is PRE_FREEZE: `freeze_requirements.implementation_hashes_frozen=false` and `dry_run_authorized=false`. It cannot issue a certificate, consume a claim, create an output root, launch a model, execute Gate 0, or access any split.

The sole R18 correction is administrative freeze-record closure: its future finalizer must bind the complete R16-compatible source-field projection, the closed nonprotocol manifest projection, the non-self registry projection, and a runner-derived implementation observation. It must not treat the frozen R17 record as sufficient.

## 4. Scientific invariance and forensic boundary

R18 changes no method, architecture, objective, fixture, threshold, seed, split, optimizer setting, registered step count, gate order, survival logic, formal boundary, claim flag, or two-child routing. The R16 failed audit and R17 incomplete freeze record remain immutable forensic evidence and cannot authorize R18. Dataset/model downloads, real-image training, clinical claims, formal-test reveal, formal main experiments, and formal ablations remain HOLD or SEALED.

The frozen R14 v5 validator bundle and every R14 pin are retained unchanged. Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or terminated; R18 never authorizes `scancel 4161`.

## 5. R18 independent-reproduction boundary

R18 registers fresh R18 phase, audit, certificate, claim, failure, and reproduction namespaces only. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths are registered only for fail-closed rejection; none is authorized by R18.
