# CAPES-CI QPTM R25 Canonical-Exclusion Protocol Frozen

Status: `FROZEN_BEFORE_R25_REPRODUCTION`
Date: 2026-07-25
Protocol ID: `CAPES_CI_QPTM_R25_2026_07_25`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R25. It derives
from the exact frozen R24 protocol and complete registry pinned below. Runtime
code must read this first JSON object directly and must not recursively merge
R24. Before one-shot finalization, R25 cannot issue an audit or certificate,
...
```json
{
  ...
  "base_dependency": {
    ...
    "protocol_sha256": "2f8b1577d193bf6a63d5146853ffd2b5fdc70918b6937652ff2cef47d8cc8e44",
    "registry_sha256": "3bfe2466b00bc4f1c24a066ef40d48a6a0ae6508ff93bb8224b2620fd908827b",
    "registry_sha256_semantics": "r24_full_canonical_registry_including_complete_freeze_record",
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R25_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R25_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R25",
    "smoke_authorized": "AUTHORIZED_R25_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R25_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R25_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R25_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R25_",
    "technical_failure": "TECHNICAL_FAILURE_R25_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R25_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R25_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "b520cf8d0b8f3c63bad1f4ce407a8d54e21b4827b744c51012ca7721266af242",
      "scripts/run_query_anchor_r4_reproduction.py": "09fde2c457096a8a135ff981703c30f7195b846ccc8a8c36e0ba8d5c91cd9fd8",
      ...
      "src/visualvit/r6_validation.py": "3b547df24d26ec8641772fb6b233d45584e228ea87b72fd8ae42c4b8b51e42e7",
      ...
      "tests/test_frozen_source_manifest_cross_process.py": "7d82a2c8a64dfa51ba84f9a2ffe092eb56c66cc008d7988f0cb0f66a4162f027",
      "tests/test_matching.py": "aaa90cdfe1e29c6b5bad8a644f4c1c56970031246226946f891d1139dc3dec5f",
      "tests/test_query_anchor_r4_runner.py": "324eeaa8e94478e9e120b40625c32d9f744c03acb9ae7ae1102d318c629e1301",
      ...
      "tests/test_r6_reproduction.py": "433affdbedbe14118fba3984c3746d262a59904e5e1d2d1811dde679e9d73fa3",
      ...
      "tests/test_r6_validation.py": "438d8c092ac02e4490c65c48b6879d4e714797abd0be1b6e2a7b400583bd72ce",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r24_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R25_2026-07-25.md",
    ...
    "legacy_source_manifest_authority_sha256_field_forbidden": true,
  ...
  "freeze_record": {
    "schema_version": "r24_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "26aa0b26a6238909fbe8c7cb28e9ac546da6e48ca999ae1e1df95ed5b3afcceb",
    "implementation_observation_sha256": "25fed64b7a2806fa6f4a34af8f446056958f1f9b4127742393cb3e894dc9cc2c",
    "runner_sha256": "b520cf8d0b8f3c63bad1f4ce407a8d54e21b4827b744c51012ca7721266af242",
    "reproduction_launcher_sha256": "09fde2c457096a8a135ff981703c30f7195b846ccc8a8c36e0ba8d5c91cd9fd8",
    ...
    "runner_tests_sha256": "324eeaa8e94478e9e120b40625c32d9f744c03acb9ae7ae1102d318c629e1301",
    ...
    "semantic_validator_sha256": "3b547df24d26ec8641772fb6b233d45584e228ea87b72fd8ae42c4b8b51e42e7",
    "semantic_validator_tests_sha256": "438d8c092ac02e4490c65c48b6879d4e714797abd0be1b6e2a7b400583bd72ce",
    "boundary_tests_sha256": "93099e5ad511d21f78ff88aa234ff42269db246d9d86b90be07af628a534588a",
    "reproduction_tests_sha256": "433affdbedbe14118fba3984c3746d262a59904e5e1d2d1811dde679e9d73fa3",
    "gate_spec_sha256": "9ee58dd2053816d216bc5ed8d339fb4bb4488c092fccd090cd05bcbccd385715",
    "closed_manifest_sha256": "5c441f09d2d0951544163799e909936b64cae9c8ec1000fa79bf9f3bfa3e48ea",
    "canonical_registry_sha256": "e78002df8d1704a9af10c9bdb561a98886c5862ede30101dc2b3b51334de304c",
  ...
  "corrective_scope": {
    "r24_administrative_deltas": [
      "add_expected_leaf_json_pointer_to_post_eligibility_scientific_canonical_compare_volatile_exclusions"
    ],
    "exact_administrative_delta_pointer": "/reproduction_contract/volatile_exclusion_paths",
    "no_scientific_method_or_data_delta": true,
    "r23_failure_artifacts_metadata_only_ineligible_for_r24": true,
    "fresh_r24_authorization_claim_failure_and_reproduction_namespaces_only": true,
  ...
  "phase_authorization_contract": {
    "schema_version": "r24_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r24_registered.py",
        "sha256": "8628d4442343b8b0d407723997f0a77b62471f003b01c4c58bd4103157e441ea",
    ...
    "authorization_root_relative": "artifacts/calibration/.r24_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r24_phase_authorizations/claims",
    "claim_schema_version": "r24_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R24_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r24_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r24_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r24_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R24_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R24_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r24_reproduction_local_20260724_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r24_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r24_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r24_reproduction_local_20260724_v1/process_a"
        },
        "process_b": {
          "schema_version": "r24_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r24_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r24_reproduction_local_20260724_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r24_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r24_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R24_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R24_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r24_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r24_phase_authorizations/reproduction_authorization.json",
      ...
      "source_manifest_authority_contract": {
        ...
        "schema_version": "r24_source_manifest_v1",
        "manifest_exact_top_level_keys": [
          "schema_version",
          "allowlist",
          "files",
    ...
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R24_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R24_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r24_r14_provenance_comparator_routing_v1",
  ...
  "r24_pre_finalization_runner_contract": {
    "required_before_finalizer_import_or_implementation_observation": true,
    "runner_must_natively_load_protocol_relative_path": "refine-logs/CALIBRATION_PROTOCOL_R24_2026-07-24.md",
    "runner_must_natively_expose_protocol_id": "CAPES_CI_QPTM_R24_2026_07_24",
    "runner_must_natively_expose_registry_object": true,
    "runner_must_natively_expose_r24_schema_and_run_namespaces": true,
  ...
  "r24_launcher_owned_issuer_transaction_contract": {
    "transaction_owner": "scripts/run_query_anchor_r4_reproduction.py",
    "issuer_invocation_count_exact": 1,
    "synchronous": true,
    "retry_allowed": false,
  ...
  "registered_r21_source_manifest_failure_forensic_evidence": {
    ...
    "artifacts": {
      "registered_postrun_audit": {
        ...
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      },
      "process_a_authorization": {
    ...
    "disposition": "immutable_ineligible_forensic_metadata_only_not_an_r24_authorization_prerequisite_or_reusable_authority",
    ...
    "r21_artifacts_authorize_r24": false,
    "r21_artifacts_are_r24_prerequisites": false,
    "pins_are_registry_metadata_only": true,
    "live_path_existence_or_hash_revalidation_required_for_r24_freeze": false,
    "sole_r24_freeze_base_prerequisite": "frozen_r21_protocol_bytes_and_full_canonical_registry",
    "scientific_method_evidence": false
  },
  "registered_r22_canonical_compare_failure_forensic_evidence": {
    "source_protocol": {
      "path": "refine-logs/CALIBRATION_PROTOCOL_R22_2026-07-23.md",
      "protocol_sha256": "57d64b81a79554884b2f3c9cb484fb461441b8c6ba72a72fbc062afc05ec7ec1",
      "registry_sha256": "dd318120542252ffc78079ddf71843f41cfb71dae06b73eb6d5f230829f3ca3b",
      "registry_sha256_semantics": "r22_full_canonical_registry"
    },
    "artifacts": {
      "registered_postrun_audit": {
        "path": "artifacts/calibration/.r22_phase_authorizations/r14_registered_local_postrun_audit.json",
        "file_sha256": "53917a161876d176c7f60c15bc55c00e9b96209ef8ff98d608b0dc738095bac9",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_authorization": {
        "path": "artifacts/calibration/.r22_phase_authorizations/reproduction_process_a_authorization.json",
        "file_sha256": "dd5405b43b5af45c8be0510f9e7d6fc06477ac09b7273df89fb31d02649d2f9d",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_authorization": {
        "path": "artifacts/calibration/.r22_phase_authorizations/reproduction_process_b_authorization.json",
        "file_sha256": "8efa3d999b18b8761b31bd8bd17186a2d05b234c98f61818a3ea7134695d0438",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_claim": {
        "path": "artifacts/calibration/.r22_phase_authorizations/claims/reproduction_process_a_authorization.4662ea41-10ff-4a23-ace1-a472275c0882.8016b734556d0bb3b9602b6bce71488b9e41c0870845126d35203afc2a3292d0.process_a.claim.json",
        "file_sha256": "0cb6d02133fc9b756c1116d2cafb9ea380020eb6d98db02a5d2d611d549b8c41",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_claim": {
        "path": "artifacts/calibration/.r22_phase_authorizations/claims/reproduction_process_b_authorization.a51ced02-c219-41c7-83e7-b35df2f358ca.57e76e0733c8769ab8595d8cce56c3ca0e41f2dcd77f65d062832b9cf13f5963.process_b.claim.json",
        "file_sha256": "18da4031508b657bf31bb3f27af7530e96100a7d3281622e104503ee1b40b59d",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_summary": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/process_a/summary.json",
        "file_sha256": "ee4bd4e21686bf6893359d6025f293ce61991e853e8bacd83dc1b13d1a812fe9",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_summary": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/process_b/summary.json",
        "file_sha256": "71b820d439fe14ad892939b08561a42a5be013929b295cd7df1d7b1d78bf1208",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "launcher_failure": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/failure.json",
        "file_sha256": "58dd37444efcea295bcf7f10033800a4aacb8d27001980bba18db46bcc6dc6d1",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_stdout": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/process_a.stdout.log",
        "file_sha256": "b0b5163f12dd0f6db108858032d29075a36f1fca1d245b2f862ee054f083e064",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_stderr": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/process_a.stderr.log",
        "file_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
      ...
      "process_b_stdout": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/process_b.stdout.log",
        "file_sha256": "85c40d6c77b2677f7d4a978bdd83557c3f58f829cf3ff4c063696916fa2b3757",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_stderr": {
        "path": "artifacts/calibration/capes_ci_qptm_r22_reproduction_local_20260723_v1/process_b.stderr.log",
        "file_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
      ...
      "scheduled_launcher_result": {
        "path": "artifacts/calibration/r22_launcher_logs/launcher_process_result.json",
        "file_sha256": "95f03e63d1c728cc77ee9e9f6840b2b3945cf9f2b7a601be973ed819160cd1de",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "scheduled_launcher_log": {
        "path": "artifacts/calibration/r22_launcher_logs/launcher_stdout_stderr.log",
        "file_sha256": "3a82d112bef348842ce454a9e1b0953c74a414d1e00110527123e5d0c2025040",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
    ...
    "failure_class": "R22_CANONICAL_COMPARE_EXPECTED_CHECK_SET_OMISSION",
    "disposition": "immutable_ineligible_forensic_metadata_only_not_an_r24_authorization_prerequisite_or_reusable_authority",
    "r22_process_a_returncode_zero": true,
    "r22_process_a_gates_0_to_7_passed": true,
    "r22_process_a_strict_summary_validation_passed": true,
    "r22_process_b_returncode_zero": true,
    "r22_process_b_gates_0_to_7_passed": true,
    "r22_process_b_strict_summary_validation_passed": true,
    "parent_failure_stage": "canonical_compare",
    "producer_emitted_check": "independent_process_pids",
    "strict_validator_expected_check_omission": "independent_process_pids",
    "parent_certificate_issued": false,
    "r22_artifacts_authorize_r24": false,
    "r22_artifacts_are_r24_prerequisites": false,
    "pins_are_registry_metadata_only": true,
    "live_path_existence_or_hash_revalidation_required_for_r24_freeze": false,
    "sole_r24_freeze_base_prerequisite": "frozen_r22_protocol_bytes_and_full_canonical_registry",
    "scientific_method_evidence": false
  },
  "registered_r23_canonical_compare_failure_forensic_evidence": {
    "source_protocol": {
      "path": "refine-logs/CALIBRATION_PROTOCOL_R23_2026-07-24.md",
      "protocol_sha256": "36e29039eb1d56012a8105a4da0aba8e1c5e2095d255f9a42f4ec22c95f173dc",
      "registry_sha256": "fdf4ca8fbf4a8389183ffbb5d234ab2392c666dd69263fb91d125cdb7f42b81c",
      "registry_sha256_semantics": "r23_full_canonical_registry"
    },
    "artifacts": {
      "registered_postrun_audit": {
        "path": "artifacts/calibration/.r23_phase_authorizations/r14_registered_local_postrun_audit.json",
        "file_sha256": "609eb9b63ba7c91c5284976cee1a0f1f8523d1ce22ce57bc589b63eec3b5aca5",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_authorization": {
        "path": "artifacts/calibration/.r23_phase_authorizations/reproduction_process_a_authorization.json",
        "file_sha256": "9508dd8b6ddb958efd888fb5966994fa47e847631903772b202dfbd9f70a1067",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_authorization": {
        "path": "artifacts/calibration/.r23_phase_authorizations/reproduction_process_b_authorization.json",
        "file_sha256": "2cd86b5ca9ac19a3e0674ca8adfcc8bb50d2778cb75d32bff4f9196bd8c42ff3",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_claim": {
        "path": "artifacts/calibration/.r23_phase_authorizations/claims/reproduction_process_a_authorization.e6d302e9-6d41-4022-b94c-da5c7784a29c.c0dacc6fb237170c4f49c97cab421d5c0ea9942287c759ff4bac9924631a8315.process_a.claim.json",
        "file_sha256": "84b6fe4dbaedd3a3c0a39581a7e64caa60647bea0bf6bb4934fbbcb3336a9dbb",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_claim": {
        "path": "artifacts/calibration/.r23_phase_authorizations/claims/reproduction_process_b_authorization.938f84b6-450c-4db8-bc21-385c499d561f.5b18e3bd91087bca1e1cfe654fd7f563ae6cd9b652dc730861bffc2ba86babb4.process_b.claim.json",
        "file_sha256": "c6bd2f8bdc42ebf0ac67ce3e5ba4b0cae64ddedbc81aead52e0d09e0e00fdda1",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_summary": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_a/summary.json",
        "file_sha256": "ed95e81ae773150e22edbfa4c97f5331bf9b629b5a6f0f43f57306817ef7b214",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_summary": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_b/summary.json",
        "file_sha256": "b5b5c623e8c13298ef3767796598f7a4b56c40ae195f444e1dd414117e5eebed",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      },
      "parent_reproduction_certificate": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/reproduction_certificate.json",
        "file_sha256": "09cc26e1ef0398f5492d882ffc2b13d074d3fd8ebcf28641cde2575ae0539682",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_stdout": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_a.stdout.log",
        "file_sha256": "02fad45036c5f788a19edee6eb8fadc23cf8f2c6854f54f769c9c58d67cf6363",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_a_stderr": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_a.stderr.log",
        "file_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
      ...
      "process_b_stdout": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_b.stdout.log",
        "file_sha256": "e87289a5de4fffbc81c2bc2a2fe3150656c14e40f2bf7ceb06c5faefdd72f44c",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "process_b_stderr": {
        "path": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_b.stderr.log",
        "file_sha256": "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
      ...
      "scheduled_launcher_result": {
        "path": "artifacts/calibration/r23_launcher_logs/launcher_process_result.json",
        "file_sha256": "62374a531877f23a11367260a258e512dcdfdddbf3d94d78078861d79adcf633",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      ...
      "scheduled_launcher_log": {
        "path": "artifacts/calibration/r23_launcher_logs/launcher_stdout_stderr.log",
        "file_sha256": "97c78c20977fd150db80d253a882c81df594c50fcd220171609e607bbe63770a",
        "retained_without_rewrite": true,
        "eligible_r24_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
    ...
    "failure_class": "R23_CANONICAL_COMPARE_PROCESS_SPECIFIC_EXPECTED_LEAF",
    "disposition": "immutable_ineligible_forensic_metadata_only_not_an_r24_authorization_prerequisite_or_reusable_authority",
    "r23_process_a_returncode_zero": true,
    "r23_process_a_gates_0_to_7_passed": true,
    "r23_process_a_strict_summary_validation_passed": true,
    "r23_process_b_returncode_zero": true,
    "r23_process_b_gates_0_to_7_passed": true,
    "r23_process_b_strict_summary_validation_passed": true,
    "parent_failure_stage": "canonical_compare",
    "canonical_mismatch_count": 1,
    "canonical_mismatch_json_pointer": "/provenance/output_root_entry_evidence/output_root_contract/expected_leaf",
    "canonical_mismatch_semantics": "process_a_and_process_b_require_distinct_output_root_leaf_names",
    "parent_certificate_issued": true,
    "parent_certificate_status": "STOP_R23_INDEPENDENT_REPRODUCTION",
    "r23_artifacts_authorize_r24": false,
    "r23_artifacts_are_r24_prerequisites": false,
    "pins_are_registry_metadata_only": true,
    "live_path_existence_or_hash_revalidation_required_for_r24_freeze": false,
    "sole_r24_freeze_base_prerequisite": "frozen_r23_protocol_bytes_and_full_canonical_registry",
    "scientific_method_evidence": false
  },
  "r24_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R24_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R24_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R24_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R24_REPRODUCTION",
    ...
    "freeze_record_semantics": "r24_complete_nonself_final_protocol_projection_contract_v1",
    ...
    "native_runner_precondition_ref": "/r24_pre_finalization_runner_contract"
  }
}
```
...
R24 is PRE_FREEZE. Its sole execution-control delta adds
`/provenance/output_root_entry_evidence/output_root_contract/expected_leaf`
to the volatile paths excluded only after both children pass strict eligibility
and only for their scientific canonical comparison. The exact 11-member
comparison-check contract is inherited unchanged. Missing, extra, or false
comparison checks remain terminal failures.

R24 is frozen before independent reproduction: native implementation and external-materializer hashes are frozen, but freeze alone authorizes no execution. Independent reproduction remains gated by the launcher's synchronous exactly-once no-retry issuer transaction, fresh R24 audit, two fresh R24 child certificates, claims, and runner verification. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths remain unauthorized.

## 4. Scientific invariance and forensic boundary

This is an administrative integrity delta only. R24 changes no scientific
...
data contract, or two-child routing. R23 processes A and B both completed Gates
0 through 7 and strict summary validation, but their parent failed because the
process-specific `expected_leaf` values (`process_a` and `process_b`) remained
inside the scientific canonical payload. Every R23 runtime artifact remains
immutable, ineligible forensic metadata only and cannot authorize or serve as
a prerequisite for R24.
...
## 5. R24 independent-reproduction boundary

R24 registers fresh `.r24_phase_authorizations`, R24 audit, child-certificate,
