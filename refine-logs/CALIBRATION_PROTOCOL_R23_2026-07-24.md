# CAPES-CI QPTM R23 Canonical-Comparator Protocol Frozen

Status: `FROZEN_BEFORE_R23_REPRODUCTION`
Date: 2026-07-24
Protocol ID: `CAPES_CI_QPTM_R23_2026_07_24`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R23. It derives
from the exact frozen R22 protocol and complete registry pinned below. Runtime
code must read this first JSON object directly and must not recursively merge
R22. Before one-shot finalization, R23 cannot issue an audit or certificate,
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R23_2026_07_24",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r22_full_canonical_registry_including_complete_freeze_record",
  ...
  "schema_versions": {
    "resolver": "r23_resolver_v1",
    "summary": "r23_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r23_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r23_initialization_evidence_v1",
    ...
    "reproduction": "r23_reproduction_certificate_v1",
    "failure": "r23_atomic_failure_v1",
    "freeze_record": "r23_freeze_record_v1",
    "dryrun_postrun_audit": "r23_dryrun_postrun_audit_v1",
    "smoke_authorization": "r23_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r23_smoke_postrun_audit_v1",
    "registered_authorization": "r23_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r23_dryrun_20260724_v1",
      "smoke": "capes_ci_qptm_r23_smoke_seed17_20260724_v1",
      "registered_local": "capes_ci_qptm_r23_registered_local_20260724_v1",
      "registered_slurm4161": "capes_ci_qptm_r23_registered_slurm4161_20260724_v1",
      "reproduction_local": "capes_ci_qptm_r23_reproduction_local_20260724_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r23_reproduction_slurm4161_20260724_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R23_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R23_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R23",
    "smoke_authorized": "AUTHORIZED_R23_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R23_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R23_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R23_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R23_",
    "technical_failure": "TECHNICAL_FAILURE_R23_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R23_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R23_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "01b5f565be40135537ebce7743c33d6594ac96b4085f2b6e62ae4343bb89312b",
      "scripts/run_query_anchor_r4_reproduction.py": "cb444b93280d6637772674f0a7e4b0217532cff250aa0c9fd69239103865ed05",
      ...
      "src/visualvit/r6_validation.py": "279505aad4381ed20f9a115d8382bc5cc850b09f5031507ba2df40a8932cc5b0",
      ...
      "tests/test_frozen_source_manifest_cross_process.py": "ba79ff4bbce81075bb22cb7e046235630e123040270ecc21e76793ca9e31b5ae",
      "tests/test_matching.py": "aaa90cdfe1e29c6b5bad8a644f4c1c56970031246226946f891d1139dc3dec5f",
      "tests/test_query_anchor_r4_runner.py": "811f4140cb21476da07983bee0be1f5e34b82b78b8d774638dce513fba38a2e1",
      ...
      "tests/test_r6_reproduction.py": "b82af880745cb0ae855b7a27624726efb9c05aaafa645704f5cb523604ce098b",
      ...
      "tests/test_r6_validation.py": "8b75c2dfe6ac491c51485eada52b4ad49b38fc6d9c20f3437a53a2ffaae8de47",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r23_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R23_2026-07-24.md",
  ...
  "freeze_record": {
    "schema_version": "r23_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "b771d6a53467f000823e1f9bd66fb37408a6bae4f6694e96a65b932f2fb65987",
    "implementation_observation_sha256": "6b68d8f482a13556ba03449fd49ddbc7e717b21298df3f04d0f016b5eb0db738",
    "runner_sha256": "01b5f565be40135537ebce7743c33d6594ac96b4085f2b6e62ae4343bb89312b",
    "reproduction_launcher_sha256": "cb444b93280d6637772674f0a7e4b0217532cff250aa0c9fd69239103865ed05",
    ...
    "runner_tests_sha256": "811f4140cb21476da07983bee0be1f5e34b82b78b8d774638dce513fba38a2e1",
    ...
    "semantic_validator_sha256": "279505aad4381ed20f9a115d8382bc5cc850b09f5031507ba2df40a8932cc5b0",
    "semantic_validator_tests_sha256": "8b75c2dfe6ac491c51485eada52b4ad49b38fc6d9c20f3437a53a2ffaae8de47",
    "boundary_tests_sha256": "93099e5ad511d21f78ff88aa234ff42269db246d9d86b90be07af628a534588a",
    "reproduction_tests_sha256": "b82af880745cb0ae855b7a27624726efb9c05aaafa645704f5cb523604ce098b",
    "gate_spec_sha256": "9ee58dd2053816d216bc5ed8d339fb4bb4488c092fccd090cd05bcbccd385715",
    "closed_manifest_sha256": "b49274e63bfb68d4f465edec9bdf278d66bbcf83c6dd92ae777cd4b4f1b3dd82",
    "canonical_registry_sha256": "300a5e4c5b69b3c48c8efdfcfafc3be9ebca90708fe96f48c485bd50f5064654",
  ...
  "corrective_scope": {
    "r23_administrative_deltas": [
      "add_independent_process_pids_to_strict_canonical_compare_expected_check_set",
      "retain_exact_key_membership_fail_closed_for_missing_or_extra_checks",
      "retain_false_independent_process_pids_as_scientific_gate_failure"
    ],
    "no_scientific_method_or_data_delta": true,
    "r22_failure_artifacts_metadata_only_ineligible_for_r23": true,
    "fresh_r23_authorization_claim_failure_and_reproduction_namespaces_only": true,
  ...
  "phase_authorization_contract": {
    "schema_version": "r23_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r23_registered.py",
        "sha256": "251d909bc5b0c0d6d5f42d60fc5d6b9a657dee8fdce1b2739902ea420dbe072e",
    ...
    "authorization_root_relative": "artifacts/calibration/.r23_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r23_phase_authorizations/claims",
    "claim_schema_version": "r23_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R23_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r23_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r23_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r23_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R23_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R23_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      "issuer_invocation": {
        ...
        "preissued_r23_audit_or_child_certificates_forbidden": true,
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r23_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r23_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_a"
        },
        "process_b": {
          "schema_version": "r23_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r23_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r23_reproduction_local_20260724_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r23_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r23_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R23_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R23_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r23_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r23_phase_authorizations/reproduction_authorization.json",
      "launcher_owned_issuer_transaction_contract": {
        ...
        "synchronous": true,
        "retry_allowed": false,
        "preissued_r23_audit_allowed": false,
        "preissued_r23_child_certificates_allowed": false,
        "required_precheck_order": [
          "target_output_parent_absent",
          "r23_authority_namespace_absent",
          "r23_registered_audit_absent",
          "r23_process_a_certificate_absent",
          "r23_process_b_certificate_absent"
        ],
        ...
        "r20_authority_namespace_is_forensic_only_and_never_read_as_r23_authority": true,
        "r21_authority_namespace_is_forensic_only_and_never_read_as_r23_authority": true,
        "r22_authority_namespace_is_forensic_only_and_never_read_as_r23_authority": true
      },
      ...
      "source_manifest_authority_contract": {
        ...
        "schema_version": "r23_source_manifest_v1",
        "manifest_exact_top_level_keys": [
          "schema_version",
          "allowlist",
          "files",
    ...
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R23_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R23_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r23_r14_provenance_comparator_routing_v1",
  ...
  "scientific_invariance_contract": {
    ...
    "administrative_delta_json_pointers": [
      "/reproduction_contract/canonical_comparison_expected_check_keys",
  ...
  "r23_pre_finalization_runner_contract": {
    "required_before_finalizer_import_or_implementation_observation": true,
    "runner_must_natively_load_protocol_relative_path": "refine-logs/CALIBRATION_PROTOCOL_R23_2026-07-24.md",
    "runner_must_natively_expose_protocol_id": "CAPES_CI_QPTM_R23_2026_07_24",
    "runner_must_natively_expose_registry_object": true,
    "runner_must_natively_expose_r23_schema_and_run_namespaces": true,
  ...
  "r23_launcher_owned_issuer_transaction_contract": {
    "transaction_owner": "scripts/run_query_anchor_r4_reproduction.py",
    "issuer_invocation_count_exact": 1,
    "synchronous": true,
    "retry_allowed": false,
  ...
  "registered_r21_source_manifest_failure_forensic_evidence": {
    ...
    "artifacts": {
      "registered_postrun_audit": {
        ...
        "retained_without_rewrite": true,
        "eligible_r23_authorization": false,
        "eligible_engineering_evidence": false,
        "scientific_method_evidence": false
      },
      "process_a_authorization": {
    ...
    "disposition": "immutable_ineligible_forensic_metadata_only_not_an_r23_authorization_prerequisite_or_reusable_authority",
    ...
    "r21_artifacts_authorize_r23": false,
    "r21_artifacts_are_r23_prerequisites": false,
    "pins_are_registry_metadata_only": true,
    "live_path_existence_or_hash_revalidation_required_for_r23_freeze": false,
    "sole_r23_freeze_base_prerequisite": "frozen_r21_protocol_bytes_and_full_canonical_registry",
    "scientific_method_evidence": false
  },
  "registered_r22_canonical_compare_failure_forensic_evidence": {
    ...
    "r22_artifacts_authorize_r23": false,
    "r22_artifacts_are_r23_prerequisites": false,
    "pins_are_registry_metadata_only": true,
    "live_path_existence_or_hash_revalidation_required_for_r23_freeze": false,
    "sole_r23_freeze_base_prerequisite": "frozen_r22_protocol_bytes_and_full_canonical_registry",
    "scientific_method_evidence": false
  },
  "r23_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R23_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R23_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R23_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R23_REPRODUCTION",
    ...
    "freeze_record_semantics": "r23_complete_nonself_final_protocol_projection_contract_v1",
    ...
    "native_runner_precondition_ref": "/r23_pre_finalization_runner_contract"
  }
}
```
...
R23 is PRE_FREEZE. Its sole execution-control delta registers the exact
11-member canonical-comparison check set already emitted by the native
producer, including `independent_process_pids`. Missing or extra keys remain
terminal technical failures. A present false independence check remains a
scientific comparison-gate failure.

R23 is frozen before independent reproduction: native implementation and external-materializer hashes are frozen, but freeze alone authorizes no execution. Independent reproduction remains gated by the launcher's synchronous exactly-once no-retry issuer transaction, fresh R23 audit, two fresh R23 child certificates, claims, and runner verification. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths remain unauthorized.

## 4. Scientific invariance and forensic boundary

This is an administrative integrity delta only. R23 changes no scientific
...
data contract, or two-child routing. R22 processes A and B both completed Gates
0 through 7 and strict summary validation, but the parent failed because its
strict expected-check set omitted the producer-owned
`independent_process_pids` key. Every R22 runtime artifact remains immutable,
ineligible forensic metadata only and cannot authorize or serve as a
prerequisite for R23.
...
## 5. R23 independent-reproduction boundary

R23 registers fresh `.r23_phase_authorizations`, R23 audit, child-certificate,
