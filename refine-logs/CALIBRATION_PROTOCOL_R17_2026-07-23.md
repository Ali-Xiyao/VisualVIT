# CAPES-CI QPTM R17 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R17_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R17_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R17. It is derived
from the exact frozen R16 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R17 implementation hashes,
...
R14 and all earlier artifacts remain immutable evidence. R17 neither repairs
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R17_2026_07_23",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r16_final_freeze_record_canonical_registry_projection",
  ...
  "schema_versions": {
    ...
    "freeze_record": "r17_freeze_record_v1",
  ...
  "implementation_observation_expected": {
    "schema_version": "r17_implementation_observation_v1",
    "source_hashes": {
      ".tmp/materialize_r17_candidate.py": "549ed78e8a611741a715a57a7d0b5b1e7762110122d97dd238fbc672cd4d39a1",
      ".tmp/finalize_r17_protocol.py": "dca159d5422d825dc01664e050014fdf9d42a2181191f5f9d7a6f9fc2e1333de",
      ".tmp/audit_r17_registered.py": "c7a55e19ab4b7693b72e744316cb7d5e8c7e0543d12b4792e5939b2478d8c281"
    }
  },
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r17_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R17_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r17_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "c1f9f369a55fccb8e7f2ccd0d98b808130a40b93c78abc0ad8c007c007a84d23",
    "candidate_materializer_sha256": "549ed78e8a611741a715a57a7d0b5b1e7762110122d97dd238fbc672cd4d39a1",
    "finalizer_sha256": "dca159d5422d825dc01664e050014fdf9d42a2181191f5f9d7a6f9fc2e1333de",
    "registered_auditor_sha256": "c7a55e19ab4b7693b72e744316cb7d5e8c7e0543d12b4792e5939b2478d8c281",
    "canonical_registry_sha256": "164c66d854b287d133f61535b418bd8d3e39ec3004bf82edad3523c73b242325"
  },
  ...
  "corrective_scope": {
    "sole_r17_semantic_delta": "route_R14_provenance_comparators_only_to_the_agreeing_frozen_R14_bundle_origin_and_registered_R14_protocol_pins_not_to_R16_direct_base_pins",
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r17_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r17_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r17_registered.py",
        "sha256": "c7a55e19ab4b7693b72e744316cb7d5e8c7e0543d12b4792e5939b2478d8c281",
    ...
    "authorization_root_relative": "artifacts/calibration/.r17_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r17_phase_authorizations/claims",
    "claim_schema_version": "r17_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R17_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r17_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r17_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r17_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R17_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R17_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r17_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r17_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r17_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r17_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r17_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r17_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r17_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r17_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r17_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R17_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R17_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r17_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r17_phase_authorizations/reproduction_authorization.json"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R17_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R17_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r17_r14_provenance_comparator_routing_v1",
  ...
  "registered_r16_failed_audit_forensic_evidence": {
    ...
    "disposition": "immutable_forensic_evidence_only_not_an_r17_authorization_prerequisite",
    "retained_without_rewrite": true,
    "eligible_engineering_evidence": false,
    "scientific_method_evidence": false
  },
  "r17_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R17_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R17_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R17_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R17_REPRODUCTION",
    ...
    "additional_frozen_paths": [
      ...
      "/phase_authorization_contract/r14_provenance_comparator_routing"
    ]
  }
}
```
...
R17 is PRE_FREEZE: `freeze_requirements.implementation_hashes_frozen=false` and `dry_run_authorized=false`. It cannot issue a certificate, consume a claim, create an output root, launch a model, or access any split.

The only R17 semantic correction is routing each R14 provenance comparator through the agreeing R14 origin pins already frozen in the unchanged v5 validator bundle. The R16 direct-base pins authenticate R16 itself; they are not R14 provenance comparators.

## 4. Scientific invariance and forensic boundary

R17 changes no method, architecture, objective, fixture, threshold, seed, split, optimizer setting, registered step count, gate order, survival logic, formal boundary, claim flag, or two-child routing. The R16 failed audit remains immutable forensic evidence and is ineligible to authorize R17. Dataset/model downloads, real-image training, clinical claims, formal-test reveal, formal main experiments, and formal ablations remain HOLD or SEALED.

The frozen R14 v5 validator bundle and every R14 pin are retained unchanged. Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or terminated; R17 never authorizes `scancel 4161`.

## 5. R17 independent-reproduction boundary

R17 registers fresh R17 phase, audit, certificate, claim, failure, and reproduction namespaces only. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths are registered only for fail-closed rejection; none is authorized by R17.
