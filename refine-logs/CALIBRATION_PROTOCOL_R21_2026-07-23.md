# CAPES-CI QPTM R21 Canonical Materializer-Key Protocol Frozen

Status: `FROZEN_BEFORE_R21_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R21_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R21. It derives
from the exact frozen R20 protocol and complete registry pinned below. Runtime
code must read this first JSON object directly and must not recursively merge
R20. Before one-shot finalization, R21 cannot issue an audit or certificate,
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R21_2026_07_23",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r20_full_canonical_registry_including_complete_freeze_record",
  ...
  "schema_versions": {
    "resolver": "r21_resolver_v1",
    "summary": "r21_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r21_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r21_initialization_evidence_v1",
    ...
    "reproduction": "r21_reproduction_certificate_v1",
    "failure": "r21_atomic_failure_v1",
    "freeze_record": "r21_freeze_record_v1",
    "dryrun_postrun_audit": "r21_dryrun_postrun_audit_v1",
    "smoke_authorization": "r21_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r21_smoke_postrun_audit_v1",
    "registered_authorization": "r21_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r21_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r21_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r21_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r21_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r21_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r21_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R21_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R21_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R21",
    "smoke_authorized": "AUTHORIZED_R21_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R21_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R21_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R21_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R21_",
    "technical_failure": "TECHNICAL_FAILURE_R21_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R21_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R21_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "tests/test_query_anchor_r4_runner.py": "b21bec428dff3f57aa34962f5a3f00f91250171570adb6a2a0535b359e16eaa1",
      ...
      "tests/test_r6_reproduction.py": "3d3b8909fef29c962eb57552af2dc961c26ab33cd759bc16465dc46d9a8a0683",
      ...
      "tests/test_r6_validation.py": "5525d5017d5bcc534b032023ab41197d71f6ea6e476cbf6cb597ebd09bf0a824",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r21_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R21_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r21_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "1d52b72106b5545d3d9e17a193fd6d8e470c921d5fab1bdb1806bbd10440a6a2",
    "implementation_observation_sha256": "2881bb2fa9cf183fbc7b5810c88d619024601a1c28a8bf9bad75bc8da0efa2a4",
    "runner_sha256": "f2a80f2a57e5d925563e96e28074d7a58174f90e9c5ebb05fd50b93e729f0ecb",
    "reproduction_launcher_sha256": "3c89f00deb9a7017e536bd7b717a21b588f57728c3c46c6af387caf939154f7b",
    ...
    "runner_tests_sha256": "b21bec428dff3f57aa34962f5a3f00f91250171570adb6a2a0535b359e16eaa1",
    ...
    "semantic_validator_sha256": "9e18c69fc7fa96e25095516013467d9a5fb38e2e93f9523dd3aba5156d3e9cee",
    "semantic_validator_tests_sha256": "5525d5017d5bcc534b032023ab41197d71f6ea6e476cbf6cb597ebd09bf0a824",
    "boundary_tests_sha256": "60c895940d0f34927f44b6e1774244aba53c0d8c3ffe8fc39a05ddcc6daa39f2",
    "reproduction_tests_sha256": "3d3b8909fef29c962eb57552af2dc961c26ab33cd759bc16465dc46d9a8a0683",
    "gate_spec_sha256": "9ee58dd2053816d216bc5ed8d339fb4bb4488c092fccd090cd05bcbccd385715",
    "closed_manifest_sha256": "4eebf8d632f59c17b6042ce8480846a3afdbafe5585e862a6bc48dbad3768474",
    "canonical_registry_sha256": "b6192dffd6c561a7d80443307e71364ffc0b23a061ba09f3cd7d8bb143f6e3de",
  ...
  "corrective_scope": {
    "r21_administrative_deltas": [
      "require_active_runner_to_be_natively_R21_before_finalization",
      "replace_reproduction_issuer_materializer_id_alias_with_the_sole_issuing_materializer_id_key",
      "require_all_five_registered_consumers_to_read_the_same_canonical_key",
      "forbid_materializer_identity_alias_fallback",
      "retain_launcher_owned_synchronous_exactly_once_no_retry_issuer_transaction"
    ],
    "no_scientific_method_or_data_delta": true,
    "r20_materializer_key_failure_artifacts_preserved_as_immutable_ineligible_forensic_evidence": true,
    "r20_protocol_and_full_canonical_registry_pins_immutable": true,
    "r19_passing_audit_and_preissued_child_certificates_preserved_as_inherited_immutable_ineligible_forensic_evidence": true,
    ...
    "fresh_r21_phase_audit_certificate_claim_failure_and_reproduction_namespaces_only": true,
    "no_prior_auditor_test_or_prior_protocol_artifact_rewrite": true,
    "new_r21_auditor_and_r21_tests_allowed": true,
    "runner_change_limited_to_native_r21_authority_namespace_and_canonical_materializer_key_consumption": true,
  ...
  "phase_authorization_contract": {
    "schema_version": "r21_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r21_registered.py",
        "sha256": "5e0886f0dffc224095d93d4fbb7ea85bea5301eb51a6fef3e14de75f869df6d0",
    ...
    "authorization_root_relative": "artifacts/calibration/.r21_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r21_phase_authorizations/claims",
    "claim_schema_version": "r21_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R21_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r21_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r21_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r21_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R21_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R21_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      "issuer_invocation": {
        ...
        "preissued_r21_audit_or_child_certificates_forbidden": true,
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r21_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r21_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r21_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r21_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r21_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r21_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r21_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r21_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r21_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R21_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R21_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r21_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r21_phase_authorizations/reproduction_authorization.json",
      "launcher_owned_issuer_transaction_contract": {
        ...
        "synchronous": true,
        "retry_allowed": false,
        "preissued_r21_audit_allowed": false,
        "preissued_r21_child_certificates_allowed": false,
        "required_precheck_order": [
          "target_output_parent_absent",
          "r21_authority_namespace_absent",
          "r21_registered_audit_absent",
          "r21_process_a_certificate_absent",
          "r21_process_b_certificate_absent"
        ],
        ...
        "r20_authority_namespace_is_forensic_only_and_never_read_as_r21_authority": true
      },
      "issuing_materializer_id": "registered_reproduction_authorizer"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R21_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R21_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r21_r14_provenance_comparator_routing_v1",
  ...
  "r21_pre_finalization_runner_contract": {
    "required_before_finalizer_import_or_implementation_observation": true,
    "runner_must_natively_load_protocol_relative_path": "refine-logs/CALIBRATION_PROTOCOL_R21_2026-07-23.md",
    "runner_must_natively_expose_protocol_id": "CAPES_CI_QPTM_R21_2026_07_23",
    "runner_must_natively_expose_registry_object": true,
    "runner_must_natively_expose_r21_schema_and_run_namespaces": true,
  ...
  "r21_launcher_owned_issuer_transaction_contract": {
    "transaction_owner": "scripts/run_query_anchor_r4_reproduction.py",
    "issuer_invocation_count_exact": 1,
    "synchronous": true,
    "retry_allowed": false,
  ...
  "r21_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R21_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R21_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R21_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R21_REPRODUCTION",
    ...
    "freeze_record_semantics": "r21_complete_nonself_final_protocol_projection_contract_v1",
    ...
    "native_runner_precondition_ref": "/r21_pre_finalization_runner_contract"
  }
}
```
...
R21 is frozen before independent reproduction: implementation hashes are frozen, `dry_run_authorized=false` remains unchanged, and freeze alone authorizes no execution. The PRE_FREEZE prohibition applied until this one-shot finalization completed. Independent reproduction remains gated by the launcher's synchronous exactly-once no-retry issuer transaction, fresh R21 audit, two fresh R21 child certificates, claims, and runner verification in this authority; preissued R21 authority remains forbidden. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths remain unauthorized.

R21 makes one administrative consistency correction. The reproduction
authorization specification exposes only
`issuing_materializer_id='registered_reproduction_authorizer'`.
`issuer_materializer_id` and every alias fallback are forbidden. The issuer
materializer, launcher reopen, runner preclaim, runner summary receipt, and
runner prepublication consumers must all read that one exact canonical key.
The R20 launcher-owned synchronous exactly-once, no-retry issuer transaction is
otherwise retained unchanged.

## 4. Scientific invariance and forensic boundary

This is an administrative integrity delta only. R21 changes no scientific method, architecture, objective, fixture, threshold, seed, split, optimizer setting, registered step count, gate order, survival logic, formal boundary, claim flag, data contract, or two-child routing. The frozen R20 audit, certificates, process-A claim, failure records, and logs remain byte-pinned, immutable, ineligible forensic-only evidence. They cannot be moved, copied, consumed, or read as R21 authority. The inherited R16 through R19 evidence is likewise retained without rewrite. Dataset/model downloads, real-image training, clinical claims, formal-test reveal, formal main experiments, and formal ablations remain HOLD or SEALED.

The frozen R14 v5 validator bundle and every R14 pin are retained unchanged. Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or terminated; R21 never authorizes `scancel 4161`.

## 5. R21 independent-reproduction boundary

R21 registers fresh `.r21_phase_authorizations`, R21 audit, child-certificate,
claim, failure, and reproduction-root paths only. The launcher-owned transaction
is the sole route to R21 issuer execution. Dry-run, smoke, registered-local,
GPU, Slurm/4161, download, formal-data, and formal-test paths are registered
only for fail-closed rejection; none is authorized by R21.
