# CAPES-CI QPTM R15 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R15_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R15_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R15. It is derived
from the exact frozen R14 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R15 implementation hashes,
materializer identity, and a final freeze record. Runtime code must read the
first JSON object directly and must not recursively merge R14.

R14 and all earlier artifacts remain immutable evidence. R15 neither repairs
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R15_2026_07_23",
  ...
  "base_dependency": {
    ...
    "protocol_sha256": "11192f98ea1dcc216a6b13eb1611c8cb9ef677d75500032b6cbdf38528e125ce",
  ...
  "schema_versions": {
    "resolver": "r15_resolver_v1",
    "summary": "r15_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r15_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r15_initialization_evidence_v1",
    ...
    "reproduction": "r15_reproduction_certificate_v1",
    "failure": "r15_atomic_failure_v1",
    "freeze_record": "r15_freeze_record_v1",
    "dryrun_postrun_audit": "r15_dryrun_postrun_audit_v1",
    "smoke_authorization": "r15_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r15_smoke_postrun_audit_v1",
    "registered_authorization": "r15_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r15_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r15_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r15_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r15_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r15_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r15_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R15_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R15_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R15",
    "smoke_authorized": "AUTHORIZED_R15_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R15_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R15_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R15_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R15_",
    "technical_failure": "TECHNICAL_FAILURE_R15_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R15_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R15_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "1af3eb336877bca697248a8d53632a0bd514546f79d8a267f0fa82d39b6a36c9",
      ...
      "src/visualvit/r6_validation.py": "11446f0d5635c35327030b36efafbf7b9fece1ed8135c95839bc4e1f6f7a3be1",
      ...
      "tests/test_query_anchor_r4_runner.py": "9d91f36ce7d74d5fc63d59ff5dd84219a380b472d467cf7b6ab3383f99b46532",
      ...
      "tests/test_r6_validation.py": "e6ab9980d2c389c5b850b95a9a836d5e3d9aecc71866c155dd71cc3b19da879e",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r15_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R15_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r15_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "8a2cb02f6f34dcfa65a8d141596affdd359781fbc628c4a64eecc8f3d4c99f4b",
    "implementation_observation_sha256": "a327ce02b6148eb23f89a80333663a7043f812d6d711a1994ff07e1524a41d8f",
    "runner_sha256": "1af3eb336877bca697248a8d53632a0bd514546f79d8a267f0fa82d39b6a36c9",
    ...
    "runner_tests_sha256": "9d91f36ce7d74d5fc63d59ff5dd84219a380b472d467cf7b6ab3383f99b46532",
    ...
    "semantic_validator_sha256": "11446f0d5635c35327030b36efafbf7b9fece1ed8135c95839bc4e1f6f7a3be1",
    "semantic_validator_tests_sha256": "e6ab9980d2c389c5b850b95a9a836d5e3d9aecc71866c155dd71cc3b19da879e",
    ...
    "closed_manifest_sha256": "9ba4587225e340c09cc59f13572cbb3c598177523d7edc0a12b26579e206c91e",
    "canonical_registry_sha256": "6e6ea47953484d5dee9d4ab22b049480e8948bd568452832ed030d8befd5875d"
  },
  ...
  "corrective_scope": {
    "sole_r15_execution_delta": "new_strictly_audited_one_shot_independent_reproduction_certificate_binds_only_the_r15_reproduction_parent_and_registered_process_a_process_b_children",
    "r14_frozen_protocol_and_evidence_immutable": true,
    "no_retrospective_r14_authorization": true,
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r15_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r15_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r15_registered.py",
        "sha256": "99fa6b083614c6f2b7220873b9275baac9f714bc90e85bb8c3b030cce6d53bf7",
    ...
    "authorization_root_relative": "artifacts/calibration/.r15_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r15_phase_authorizations/claims",
    "claim_schema_version": "r15_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R15_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r15_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r15_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r15_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R15_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R15_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r15_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r15_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r15_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r15_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r15_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r15_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r15_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r15_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r15_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R15_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R15_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r15_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r15_phase_authorizations/reproduction_authorization.json"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R15_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R15_PHASE_AUTHORIZATION and create no affected child output root",
  ...
  "r15_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R15_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R15_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R15_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R15_REPRODUCTION",
...
R15 is PRE_FREEZE: `freeze_requirements.implementation_hashes_frozen=false`
and `dry_run_authorized=false`. It cannot issue a certificate, consume a claim,
create an output root, launch a model, or access any split.

After a future independent finalizer freezes the exact R15 implementation and
external-authorizer bytes, the only potentially admissible execution is a
strictly audited, one-shot, two-child CPU independent-local reproduction. The
fixed child leaves are `process_a` and `process_b` below the R15 reproduction
parent.

## 4. Scientific invariance and formal boundary

R15 changes no method, architecture, objective, fixture, threshold, seed,
split, optimizer setting, registered step count, gate order, survival logic,
formal boundary, or claim flag from frozen R14. It remains E1 synthetic
engineering only: dataset/model downloads, real-image training, clinical
claims, formal-test reveal, formal main experiments, and formal ablations remain
HOLD or SEALED.

Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or
terminated; R15 never authorizes `scancel 4161`.

## 5. R15 independent-reproduction boundary

R15 carries the immutable R14 registered-local summary into one strictly
audited, two-child CPU independent-local-reproduction authority. Its dry-run,
smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test
paths are registered only for fail-closed rejection; none is authorized by R15.
