# CAPES-CI QPTM R16 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R16_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R16_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R16. It is derived
from the exact frozen R15 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R16 implementation hashes,
materializer identity, and a final freeze record. Runtime code must read the
first JSON object directly and must not recursively merge R15.

R14 and all earlier artifacts remain immutable evidence. R16 neither repairs
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R16_2026_07_23",
  "authority_state": "FROZEN_BEFORE_R16_REPRODUCTION",
  "evidence_class": "E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY",
  "base_dependency": {
    "path": "refine-logs/CALIBRATION_PROTOCOL_R15_2026-07-23.md",
    "protocol_sha256": "c700a369e48ac1cadd5061609e956f6c1276705de8f5fcafdffb04172d760379",
    "registry_sha256": "b9368c46655f10ef86642f5e8ef160a1b95b97ab83519e1c654dcf624e30dac0",
    "authority_state": "FROZEN_BEFORE_R15_REPRODUCTION"
  },
  ...
  "schema_versions": {
    "resolver": "r16_resolver_v1",
    "summary": "r16_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r16_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r16_initialization_evidence_v1",
    ...
    "reproduction": "r16_reproduction_certificate_v1",
    "failure": "r16_atomic_failure_v1",
    "freeze_record": "r16_freeze_record_v1",
    "dryrun_postrun_audit": "r16_dryrun_postrun_audit_v1",
    "smoke_authorization": "r16_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r16_smoke_postrun_audit_v1",
    "registered_authorization": "r16_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r16_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r16_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r16_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r16_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r16_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r16_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R16_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R16_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R16",
    "smoke_authorized": "AUTHORIZED_R16_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R16_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R16_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R16_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R16_",
    "technical_failure": "TECHNICAL_FAILURE_R16_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R16_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R16_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "b1ea53ff0d4f735e9e7cbb29983e1c69b4c9ee02da7c5c6b3f74dcfcf5c6c62b",
      ...
      "src/visualvit/r6_validation.py": "fec916b0549811b25825a6c3befb07d38e5dac3e0c34c445b5e4db5e67edacaa",
      ...
      "tests/test_query_anchor_r4_runner.py": "66096ed9f75767fd6ea74e131401c5f2aa212b0f70fcc78bacd350b27d5d6b54",
      ...
      "tests/test_r6_validation.py": "78f8955d17312de876a4ea0b2e88f82dfb89e24ee59a84e85f5c8130055edb84",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r16_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R16_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r16_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "9fec3db8890443c46bb802bd7ed59390227dbf8f895ebf97958e8213a7aade6f",
    "implementation_observation_sha256": "8279b24d8df819499753e1e8e0ce6811906dca8899762c2a71c96d0b6ecf7c52",
    "runner_sha256": "b1ea53ff0d4f735e9e7cbb29983e1c69b4c9ee02da7c5c6b3f74dcfcf5c6c62b",
    ...
    "runner_tests_sha256": "66096ed9f75767fd6ea74e131401c5f2aa212b0f70fcc78bacd350b27d5d6b54",
    ...
    "semantic_validator_sha256": "fec916b0549811b25825a6c3befb07d38e5dac3e0c34c445b5e4db5e67edacaa",
    "semantic_validator_tests_sha256": "78f8955d17312de876a4ea0b2e88f82dfb89e24ee59a84e85f5c8130055edb84",
    ...
    "closed_manifest_sha256": "669c82d7e171433bfadf83d0b54f94acfb4235c93db0d309e0da035022ab8b78",
    "canonical_registry_sha256": "394f202f5694d0b4f56d741d30584515b877a67459f977853154d34f559f17c9"
  },
  ...
  "corrective_scope": {
    "sole_r16_execution_delta": "replace_r15_single_runner_snapshot_with_a_closed_hash_pinned_r14_validator_dependency_bundle_so_registered_summary_audit_cannot_import_live_workspace_validation_code",
    "r15_failed_audit_is_immutable_technical_evidence": true,
    "r15_and_r14_protocols_evidence_and_two_child_topology_immutable": true,
    "no_retrospective_r15_authorization": true,
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r16_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r16_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r16_registered.py",
        "sha256": "43efd5b8678056ed7f7d31107d315b588e33065a8a122283744d973a4afea736",
    ...
    "authorization_root_relative": "artifacts/calibration/.r16_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r16_phase_authorizations/claims",
    "claim_schema_version": "r16_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R16_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r16_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r16_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r16_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R16_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R16_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r16_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r16_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r16_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r16_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r16_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r16_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r16_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r16_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r16_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R16_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R16_INDEPENDENT_REPRODUCTION",
      ...
      "schema_version": "r16_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r16_phase_authorizations/reproduction_authorization.json"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R16_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R16_PHASE_AUTHORIZATION and create no affected child output root",
  ...
  "r16_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R16_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R16_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R16_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R16_REPRODUCTION",
    ...
    "additional_frozen_paths": [
      "/phase_authorization_contract/frozen_validator_dependency_bundle/manifest_sha256"
    ]
  }
}
```
...
R16 is PRE_FREEZE: `freeze_requirements.implementation_hashes_frozen=false` and `dry_run_authorized=false`. It cannot issue a certificate, consume a claim, create an output root, launch a model, or access any split.

After a future independent finalizer freezes the exact R16 authorizer and closed R14 validator dependency bundle, the only potentially admissible execution is the inherited strictly audited, one-shot, two-child CPU independent-local reproduction. The fixed child leaves are `process_a` and `process_b`.

## 4. Scientific invariance and formal boundary

R16 changes no method, architecture, objective, fixture, threshold, seed, split, optimizer setting, registered step count, gate order, survival logic, formal boundary, claim flag, or R15 two-child routing lock. The sole correction is audit isolation: all R14 validator imports must come from the registry-pinned self-contained bundle. Dataset/model downloads, real-image training, clinical claims, formal-test reveal, formal main experiments, and formal ablations remain HOLD or SEALED.

Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or terminated; R16 never authorizes `scancel 4161`.

## 5. R16 independent-reproduction boundary

R16 retains the immutable R14 registered-local summary and R15 reproduction-only topology. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths are registered only for fail-closed rejection; none is authorized by R16.
