# CAPES-CI QPTM R10 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R10_DRY_RUN`  
Date: 2026-07-23  
Protocol ID: `CAPES_CI_QPTM_R10_2026_07_23`  
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R10 and authorizes only the
registered R10 dry-run. The frozen R9 protocol and its complete materialized
registry are immutable base evidence. The first JSON object below is the
complete materialized effective R10 registry; runtime code must read it directly
and must not recursively merge R9.

R9 authority is pinned by protocol SHA-256
`c11a9c6677909c8ecab6645cf4d7aa79e3b7470aee573fb7e6c4a857dda00f8b`
and full materialized registry SHA-256
`bdb7ce728301f05169f6c07eb1896d9925d1ceb27311725d9ab9aca16d48acde`.

The independently audited R9 dry-run is valid E1 engineering evidence. Its
summary SHA-256 is
`d027a2d7556d30f0ba966ec6653be87aa3cf32c8f8e8a45ffa4fcf27f7b3af7f`;
its post-run audit file SHA-256 is
`de670d8d8946ddf43d0870811695b45a56724533eaaf13623a91a3f32fdaae95`;
and the audit's canonical self-hash stored in `audit_sha256` is
`3ccce3fb7431e2dea7cbf91c8df9cb661efe251813c334bcf0a2641667dc0e3f`.
The verdict is `PASS_R9_DRY_RUN_POSTRUN_AUDIT`.

The R9 seed-17 smoke pre-root phase-authorization failure is immutable at
SHA-256 `708e8a1e82fd704979eb5e2c4f794905e652afd464d42ac75eb5f948d562d77c`.
It wrote no summary and created no target output root. It is ineligible for any
phase-survival, gate, method, threshold, registered-local, server, or scientific
inference. The only R10 correction is the absent-terminal-leaf derivation rule;
no retrospective authorization is permitted.

This candidate registers immutable R9 dry-run PASS evidence and the R9 seed-17 pre-root phase-authorization technical failure. The failure is ineligible engineering or scientific evidence. The sole R10 implementation change is that canonical authorization relative-path derivation must validate the existing workspace ancestry while allowing the registered terminal target leaf to be absent before the one-shot claim and output-root creation. All scientific contracts are inherited unchanged from frozen R9. No freeze or run is authorized.

## 2. Machine-readable complete frozen registry

```json
{
  "protocol_id": "CAPES_CI_QPTM_R10_2026_07_23",
  ...
  "base_dependency": {
    ...
    "protocol_sha256": "c11a9c6677909c8ecab6645cf4d7aa79e3b7470aee573fb7e6c4a857dda00f8b",
  ...
  "schema_versions": {
    "resolver": "r10_resolver_v1",
    "summary": "r10_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r10_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r10_initialization_evidence_v1",
    ...
    "reproduction": "r10_reproduction_certificate_v1",
    "failure": "r10_atomic_failure_v1",
    "freeze_record": "r10_freeze_record_v1",
    "dryrun_postrun_audit": "r10_dryrun_postrun_audit_v1",
    "smoke_authorization": "r10_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r10_smoke_postrun_audit_v1",
    "registered_authorization": "r10_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r10_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r10_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r10_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r10_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r10_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r10_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    ...
    "protocol_frozen": "FROZEN_BEFORE_R10_DRY_RUN",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R10",
    "smoke_authorized": "AUTHORIZED_R10_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R10_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R10_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R10_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R10_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R10_",
    "technical_failure": "TECHNICAL_FAILURE_R10_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R10_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R10_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "58ceceef02683d9a3e1b1048bfc1fbac3c76d5dc6274d2472e15925f284f184b",
      "scripts/run_query_anchor_r4_reproduction.py": "8ab53f790c9f75485386de0dfa225411127285319a74b02a210ae1cfe2df9d08",
      ...
      "src/visualvit/r6_validation.py": "034bd3abd03e687ae4f9f3c2cb3d3c36f82f80544456253ea781aaa273cafce3",
      ...
      "tests/test_query_anchor_r4_runner.py": "fc8a8063758cf03935cdc79badde4ed032fc6aba9e98a78203ca39b9336a38ff",
      ...
      "tests/test_r6_reproduction.py": "4c2a2bf83d6b537df2520b1cdcfe6ade8898ca57bfbcc8b35c6533fe27d7df57",
      "tests/test_r6_runner_boundary.py": "2df2def4437dbab57c195f192f76aae24effff57fb46b4c146ec042cfda53bb9",
      "tests/test_r6_structural_audits.py": "525853077ac14c2de4b95074557fa29e4f47b490f1979fd5d4d1b0cb587b71a7",
      "tests/test_r6_validation.py": "afbec936289fd6560c2affcbd0506ed995f7b2ec54cd62bd55ae700df286570b",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r10_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R10_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r10_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "c3c4abdf26e99e25882835ced20ed79f9e412f3754797e0b41b6c17dbf72c35c",
    "implementation_observation_sha256": "0a2abfdcf468f301e3af97810a26c586e3fd26f772e512d8ef9a2c107f58139f",
    "runner_sha256": "58ceceef02683d9a3e1b1048bfc1fbac3c76d5dc6274d2472e15925f284f184b",
    "reproduction_launcher_sha256": "8ab53f790c9f75485386de0dfa225411127285319a74b02a210ae1cfe2df9d08",
    ...
    "runner_tests_sha256": "fc8a8063758cf03935cdc79badde4ed032fc6aba9e98a78203ca39b9336a38ff",
    ...
    "semantic_validator_sha256": "034bd3abd03e687ae4f9f3c2cb3d3c36f82f80544456253ea781aaa273cafce3",
    "semantic_validator_tests_sha256": "afbec936289fd6560c2affcbd0506ed995f7b2ec54cd62bd55ae700df286570b",
    "boundary_tests_sha256": "2df2def4437dbab57c195f192f76aae24effff57fb46b4c146ec042cfda53bb9",
    "reproduction_tests_sha256": "4c2a2bf83d6b537df2520b1cdcfe6ade8898ca57bfbcc8b35c6533fe27d7df57",
    ...
    "summary_roundtrip_tests_sha256": "2df2def4437dbab57c195f192f76aae24effff57fb46b4c146ec042cfda53bb9",
    "closed_manifest_sha256": "c664de1369d0080fc89e305892757010a4652aee9b76978d6483773dd9082385",
    "canonical_registry_sha256": "25cc81eeac3b02f312c929bb757969d84c8122b04e9b77533342ee473aa7a925"
  },
  ...
  "corrective_scope": {
    "allowed_changes": [
      ...
      "r10_administrative_schemas_statuses_output_roots_pre_root_and_source_closure"
    ],
    "forbidden_changes": [
      "formal_data",
      "formal_test_access",
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r10_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r10_phase_authorization_contract_v1",
    "external_materializers": {
      "dryrun_postrun_auditor": {
        "relative_path": ".tmp/audit_r10_dryrun.py",
        "sha256": "be228083bb1514b661a1e1594f0b3ef8c76b09aa699593d9a50d4bef5a547968",
      ...
      "smoke_postrun_auditor": {
        "relative_path": ".tmp/audit_r10_smoke.py",
        "sha256": "ea44a39cc52c6c8e9bbc5abbb32d6eb714489bd40f974455dd9b1dd2f888484b",
        "sha256_rule": "sha256_over_exact_regular_file_bytes",
        "invocation": {
          "working_directory_relative": ".",
          "argv0_must_resolve_to_materializer_relative_path": true,
    ...
    "authorization_root_relative": "artifacts/calibration/.r10_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r10_phase_authorizations/claims",
    "claim_schema_version": "r10_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R10_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r10_pre_root_failures",
    ...
    "dryrun_postrun_audit_contract": {
      "schema_version": "r10_dryrun_postrun_audit_v1",
      ...
      "required_exact_check_keys": [
        ...
        "launch_command_targets_exact_r10_root",
        "stderr_empty",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R10_DRY_RUN_POSTRUN_AUDIT",
        "fail": "FAIL_R10_DRY_RUN_POSTRUN_AUDIT"
      }
    },
    "smoke_postrun_audit_contract": {
      "schema_version": "r10_smoke_postrun_audit_v1",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R10_SMOKE_POSTRUN_AUDIT",
        "fail": "FAIL_R10_SMOKE_POSTRUN_AUDIT"
      }
    },
    "smoke_authorization": {
      "schema_version": "r10_smoke_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r10_phase_authorizations/smoke_authorization.json",
      "certificate_type": "smoke_authorization",
      "target_phase": "smoke",
      "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r10_smoke_seed17_20260723_v1",
      "prerequisite_phase": "dry_run",
      "prerequisite_summary_path": "artifacts/calibration/capes_ci_qptm_r10_dryrun_20260723_v1/summary.json",
      "prerequisite_summary_status": "DRY_RUN_VALIDATED_R10",
      "prerequisite_audit_path": "artifacts/calibration/capes_ci_qptm_r10_dryrun_20260723_v1/postrun_audit.json",
      "prerequisite_audit_schema_version": "r10_dryrun_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R10_DRY_RUN_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R10_SMOKE",
    ...
    "registered_authorization": {
      "schema_version": "r10_registered_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r10_phase_authorizations/registered_authorization.json",
      "certificate_type": "registered_authorization",
      "target_phase": "registered_local",
      "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r10_registered_local_20260723_v1",
      "prerequisite_phase": "smoke",
      "prerequisite_summary_path": "artifacts/calibration/capes_ci_qptm_r10_smoke_seed17_20260723_v1/summary.json",
      "prerequisite_summary_status": "SMOKE_COMPLETE_R10_NON_GATING",
      "prerequisite_audit_path": "artifacts/calibration/capes_ci_qptm_r10_smoke_seed17_20260723_v1/postrun_audit.json",
      "prerequisite_audit_schema_version": "r10_smoke_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R10_SMOKE_POSTRUN_AUDIT",
      "prerequisite_audit_self_hash_field": "audit_sha256",
      "prerequisite_audit_self_hash_rule": "sha256_of_canonical_audit_after_removing_only_top_level_audit_sha256",
      "target_seeds": [
        17,
      ...
      "authorization_status": "AUTHORIZED_R10_REGISTERED_LOCAL",
...
A frozen R10 dry-run may run only after freeze sets
...
audited R10 dry-run and must pass its own exact-key, exact-value, file-hash, and
...
authority to a successful, independently audited one-step seed-17 R10 smoke.
...
produce a pre-root `TECHNICAL_FAILURE_R10_PHASE_AUTHORIZATION`; no CLI or
...
R10 remains E1 synthetic engineering only. Dataset/model downloads, real-image
...
terminated. R10 never authorizes `scancel 4161`.
