# CAPES-CI QPTM R24 Canonical-Exclusion Protocol Frozen

Status: `FROZEN_BEFORE_R24_REPRODUCTION`
Date: 2026-07-24
Protocol ID: `CAPES_CI_QPTM_R24_2026_07_24`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R24. It derives
from the exact frozen R23 protocol and complete registry pinned below. Runtime
code must read this first JSON object directly and must not recursively merge
R23. Before one-shot finalization, R24 cannot issue an audit or certificate,
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R24_2026_07_24",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r23_full_canonical_registry_including_complete_freeze_record",
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R24_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R24_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R24",
    "smoke_authorized": "AUTHORIZED_R24_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R24_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R24_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R24_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R24_",
    "technical_failure": "TECHNICAL_FAILURE_R24_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R24_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R24_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "b2e81b6a5f6ac9f3a5c43f148069db52552bd66ca6cd6eefac1f2da8e59f09ea",
      "scripts/run_query_anchor_r4_reproduction.py": "7f9fa015e51770f04cae559b3e173010d4fc6484c1db1cf9b610505b1cdf29a7",
      ...
      "tests/test_frozen_source_manifest_cross_process.py": "eb6279d7cef857de18d9d0be5141a86686118175b001561a794399dd47c8eec5",
      "tests/test_matching.py": "aaa90cdfe1e29c6b5bad8a644f4c1c56970031246226946f891d1139dc3dec5f",
      "tests/test_query_anchor_r4_runner.py": "90358aab2ee915b812983e95fe26d7228906d9e78df21fa1ffa275bc39df913d",
      ...
      "tests/test_r6_reproduction.py": "dc0d854fa5e2e8b07678e15a973fee307102ebe7547c9c943a40a1d1c9fcc1a2",
  ...
  "freeze_record": {
    ...
    "implementation_observation_sha256": "7b2e3effeeb24a0c73664e5f462b34874ec22c5a950430bbe08e102e4d63f896",
    "runner_sha256": "b2e81b6a5f6ac9f3a5c43f148069db52552bd66ca6cd6eefac1f2da8e59f09ea",
    "reproduction_launcher_sha256": "7f9fa015e51770f04cae559b3e173010d4fc6484c1db1cf9b610505b1cdf29a7",
    ...
    "runner_tests_sha256": "90358aab2ee915b812983e95fe26d7228906d9e78df21fa1ffa275bc39df913d",
    ...
    "reproduction_tests_sha256": "dc0d854fa5e2e8b07678e15a973fee307102ebe7547c9c943a40a1d1c9fcc1a2",
    "gate_spec_sha256": "9ee58dd2053816d216bc5ed8d339fb4bb4488c092fccd090cd05bcbccd385715",
    "closed_manifest_sha256": "f53ad7615e240b51359cba6b3206a8eff3e32958277d307ca24ac88c5fe20c7d",
    "canonical_registry_sha256": "e57658c492ee14f697e34af2bff6ff29c95d4e7e9849f4f0d569621add48d28c",
