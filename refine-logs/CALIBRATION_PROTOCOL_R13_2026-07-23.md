# CAPES-CI QPTM R13 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R13_DRY_RUN`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R13_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R13. It is derived
from the exact frozen R12 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R13 implementation hashes,
materializer identity, and a final freeze record. Runtime code must read the
first JSON object directly and must not recursively merge R12.

R12 and all earlier artifacts remain immutable evidence. R13 neither repairs
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R13_2026_07_23",
  "authority_state": "FROZEN_BEFORE_R13_DRY_RUN",
  "evidence_class": "E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY",
  "base_dependency": {
    "path": "refine-logs/CALIBRATION_PROTOCOL_R12_2026-07-23.md",
    "protocol_sha256": "134cff9e7ff3c0353583cbdc43ef74e9bc515148c1e3bee2bc413dad546392ed",
    "registry_sha256": "443569184f3cf3f465d7da71bbe5bb70462733e45d883959769b5dede0e549eb",
  ...
  "schema_versions": {
    "resolver": "r13_resolver_v1",
    "summary": "r13_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r13_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r13_initialization_evidence_v1",
    ...
    "reproduction": "r13_reproduction_certificate_v1",
    "failure": "r13_atomic_failure_v1",
    "freeze_record": "r13_freeze_record_v1",
    "dryrun_postrun_audit": "r13_dryrun_postrun_audit_v1",
    "smoke_authorization": "r13_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r13_smoke_postrun_audit_v1",
    "registered_authorization": "r13_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r13_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r13_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r13_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r13_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r13_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r13_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R13_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R13_DRY_RUN",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R13",
    "smoke_authorized": "AUTHORIZED_R13_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R13_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R13_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R10_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R13_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R13_",
    "technical_failure": "TECHNICAL_FAILURE_R13_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R13_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R13_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "b8086a7b5b8797be135bc2715fa4f5e7d12c2289785e4c75ab800f1505ac65f5",
      ...
      "src/visualvit/r6_validation.py": "42061427d9d4ac9e27161b1d500c7ce475af94fabdaf876d76043c0d78a1c2a5",
      ...
      "tests/test_query_anchor_r4_runner.py": "be222be3619d15538ffbd06b7b6f7e6c794df8fbcebe04d8a7790c3e80d555af",
      ...
      "tests/test_r6_validation.py": "63b44c170aed0c44c4314f14e1248c0d5c1e9a0c455fc8cecbf10418f878b099",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r13_pre_root_failures",
  ...
  "freeze_record": {
    "schema_version": "r13_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "ce4cbebe073426a27aad4e83f96da638e9598ff0b19825ed5bfdbbb57c11d02c",
    "implementation_observation_sha256": "70c298d050b5ad0573c1e88a7ba331142e2fcdbc9fed12fe2cafd8e41b6e3f97",
    "runner_sha256": "b8086a7b5b8797be135bc2715fa4f5e7d12c2289785e4c75ab800f1505ac65f5",
    ...
    "runner_tests_sha256": "be222be3619d15538ffbd06b7b6f7e6c794df8fbcebe04d8a7790c3e80d555af",
    ...
    "semantic_validator_sha256": "42061427d9d4ac9e27161b1d500c7ce475af94fabdaf876d76043c0d78a1c2a5",
    "semantic_validator_tests_sha256": "63b44c170aed0c44c4314f14e1248c0d5c1e9a0c455fc8cecbf10418f878b099",
    ...
    "closed_manifest_sha256": "b432f57a153fa955dac19e2e74237d1550cb3d71030d581352a03704e0364cd5",
    "canonical_registry_sha256": "02f38b2a1fd6ae179b38274cb7d551b294be7a2bcc0872e35c8718ff0a094ad9"
  },
  ...
  "corrective_scope": {
    "sole_r13_execution_delta": "dry_run_is_explicitly_freeze_authorized_and_certificate_claim_forbidden_and_bypasses_only_independent_reproduction_certificate_claim_consumption; smoke_and_registered_remain_pre_root_denied; independent_reproduction_remains_native_two_child_certificate_and_claim_guarded",
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r13_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r13_phase_authorization_contract_v1",
    "external_materializers": {
      "dryrun_postrun_auditor": {
        "relative_path": ".tmp/audit_r13_dryrun.py",
        "sha256": "28615050aa98643f054617c8a08be10fe3543843255bfcc7bc0037ecc751d997",
    ...
    "authorization_root_relative": "artifacts/calibration/.r13_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r13_phase_authorizations/claims",
    "claim_schema_version": "r13_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R13_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r13_pre_root_failures",
      ...
      "summary_authorization_receipt_mode_rule": "only frozen dry_run without claim and one fixed-certificate one-shot smoke are admissible; every registered or reproduction mode is denied pre-root",
      "phase_classification_rule": "dry_run is exact CPU registered semantics at the R13 dry-run root; smoke is exact CPU seed17 one-step semantics at the R13 smoke root with fixed certificate and claim; all other modes deny pre-root"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R13_DRY_RUN",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R13_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "dryrun_postrun_audit_contract": {
      "schema_version": "r13_dryrun_postrun_audit_v1",
      "materializer_id": "dryrun_postrun_auditor",
      ...
      "required_exact_check_keys": [
        ...
        "launch_command_targets_exact_r13_root",
        "stderr_empty",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R13_DRY_RUN_POSTRUN_AUDIT",
        "fail": "FAIL_R13_DRY_RUN_POSTRUN_AUDIT"
      }
    },
    "smoke_authorization": {
      "schema_version": "r13_smoke_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r13_phase_authorizations/smoke_authorization.json",
      "certificate_type": "smoke_authorization",
      "target_phase": "smoke",
      "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r13_smoke_seed17_20260723_v1",
      "prerequisite_phase": "dry_run",
      "prerequisite_summary_path": "artifacts/calibration/capes_ci_qptm_r13_dryrun_20260723_v1/summary.json",
      "prerequisite_summary_status": "DRY_RUN_VALIDATED_R13",
      "prerequisite_audit_path": "artifacts/calibration/capes_ci_qptm_r13_dryrun_20260723_v1/postrun_audit.json",
      "prerequisite_audit_schema_version": "r13_dryrun_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R13_DRY_RUN_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R13_SMOKE",
  ...
  "r13_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R13_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R13_DRY_RUN",
    "candidate_status": "PRE_FREEZE_AWAITING_R13_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R13_DRY_RUN",
...
exact fresh R13 dry-run root is allowed without a reproduction certificate or
...
survival logic, formal boundary, or claim flag changes here. R13 remains E1
...
terminated; R13 never authorizes `scancel 4161`.

## 5. Frozen validation

The one-shot finalizer captured the exact frozen R11 base, all closed R13 source
...
## R13 correction boundary

R13 is a fresh dry-run-to-smoke authorization correction. It does not retrofit R12, authorize registered training, data/model downloads, GPU, Slurm, or allocation 4161. The only new external materializer is the frozen R13 dry-run auditor, which may issue one smoke certificate only after a fresh R13 dry-run postrun audit passes.
