# CAPES-CI QPTM R14 Ordered-Method and Phase-Authorization Protocol Frozen

Status: `FROZEN_BEFORE_R14_DRY_RUN`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R14_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R14. It is derived
from the exact frozen R13 authority pinned in the registry. It authorizes no
execution until a one-shot finalizer records fresh R14 implementation hashes,
materializer identity, and a final freeze record. Runtime code must read the
first JSON object directly and must not recursively merge R13.

R12 and all earlier artifacts remain immutable evidence. R14 neither repairs
...
```json
{
  "protocol_id": "CAPES_CI_QPTM_R14_2026_07_23",
  "authority_state": "FROZEN_BEFORE_R14_DRY_RUN",
  "evidence_class": "E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY",
  "base_dependency": {
    "path": "refine-logs/CALIBRATION_PROTOCOL_R13_2026-07-23.md",
    "protocol_sha256": "cea5d04fd8a84c4e42dad523c4e89ff532622c5b91f79dcf7d017bb217ed8459",
    "registry_sha256": "8f9929eebe7350b024fca003e0ae8683e5fe8e7773c2063b706cf2651eda8689",
    "authority_state": "FROZEN_BEFORE_R13_DRY_RUN"
  },
  ...
  "schema_versions": {
    "resolver": "r14_resolver_v1",
    "summary": "r14_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r14_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r14_initialization_evidence_v1",
    ...
    "reproduction": "r14_reproduction_certificate_v1",
    "failure": "r14_atomic_failure_v1",
    "freeze_record": "r14_freeze_record_v1",
    "dryrun_postrun_audit": "r14_dryrun_postrun_audit_v1",
    "smoke_authorization": "r14_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r14_smoke_postrun_audit_v1",
    "registered_authorization": "r14_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r14_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r14_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r14_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r14_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r14_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r14_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R14_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R14_DRY_RUN",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R14",
    "smoke_authorized": "AUTHORIZED_R14_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R14_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R14_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R14_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R14_",
    "technical_failure": "TECHNICAL_FAILURE_R14_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R14_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R14_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "tests/test_query_anchor_r4_runner.py": "8762504d63b483b1fa521df132397b0eb493097249716eae8a13e887a31fa979",
      ...
      "tests/test_r6_validation.py": "90ad60984f0e9a8f6aa7d70f8cf6483c18788827591f56beeb32638b6e7aa36c",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r14_pre_root_failures",
  ...
  "freeze_record": {
    "schema_version": "r14_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "b4288ca51f25156d313e4e56e77c9117b0bd0c0533a8f6bb643bf0e3597bf016",
    "implementation_observation_sha256": "fc23d8c3173769efe980f65b91710742940a4b5a18b051ac2f4d98645bcebf82",
    "runner_sha256": "53b511f27a2baee1fd20b7536a1a76b631b64667cacc1abb1886c887f7370f6a",
    ...
    "runner_tests_sha256": "8762504d63b483b1fa521df132397b0eb493097249716eae8a13e887a31fa979",
    ...
    "semantic_validator_sha256": "7afddde0dff6bca2d51cfedaf72676cbb8ad68a3f37626f80f5b8770ec4892a2",
    "semantic_validator_tests_sha256": "90ad60984f0e9a8f6aa7d70f8cf6483c18788827591f56beeb32638b6e7aa36c",
    ...
    "closed_manifest_sha256": "db34e80dfed87ca24cedf962be57fa7bd9fe95e55845e51400594e76b9596e68",
    "canonical_registry_sha256": "dea5de2f0e1eb48df6bb857cb63749042ae557a276a6c708c8ef3734ea24369f"
  },
  ...
  "corrective_scope": {
    "sole_r14_execution_delta": "dry_run_is_explicitly_freeze_authorized_and_certificate_claim_forbidden_and_bypasses_only_independent_reproduction_certificate_claim_consumption; smoke_and_registered_remain_pre_root_denied; independent_reproduction_remains_native_two_child_certificate_and_claim_guarded",
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r14_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r14_phase_authorization_contract_v1",
    "external_materializers": {
      "dryrun_postrun_auditor": {
        "relative_path": ".tmp/audit_r14_dryrun.py",
        "sha256": "1f84553ef967afc51c41ce75f011dfced8a919f5a0a52c5e293e40e9090f3241",
      ...
      "smoke_postrun_auditor": {
        "relative_path": ".tmp/audit_r14_smoke.py",
        "sha256": "27d70ed3a03794f031669d8cb826209082c1878079ba3cfa79109dcb7c0fd3ed",
        "sha256_rule": "sha256_over_exact_regular_file_bytes",
        "invocation": {
          "working_directory_relative": ".",
          "argv0_must_resolve_to_materializer_relative_path": true,
    ...
    "authorization_root_relative": "artifacts/calibration/.r14_phase_authorizations",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r14_phase_authorizations/claims",
    "claim_schema_version": "r14_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R14_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r14_pre_root_failures",
      ...
      "summary_authorization_receipt_mode_rule": "only frozen dry-run, fixed-cert smoke, and fixed-cert local registered execution are admissible; all other modes deny pre-root",
      "phase_classification_rule": "dry-run is exact registered CPU semantics, smoke is exact CPU seed17 one-step, registered_local is exact CPU three-seed 500-step; every other mode denies before root creation"
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R14_DRY_RUN",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R14_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "dryrun_postrun_audit_contract": {
      "schema_version": "r14_dryrun_postrun_audit_v1",
      "materializer_id": "dryrun_postrun_auditor",
      ...
      "required_exact_check_keys": [
        ...
        "launch_command_targets_exact_r14_root",
        "stderr_empty",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R14_DRY_RUN_POSTRUN_AUDIT",
        "fail": "FAIL_R14_DRY_RUN_POSTRUN_AUDIT"
      }
    },
    "smoke_authorization": {
      "schema_version": "r14_smoke_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r14_phase_authorizations/smoke_authorization.json",
      "certificate_type": "smoke_authorization",
      "target_phase": "smoke",
      "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r14_smoke_seed17_20260723_v1",
      "prerequisite_phase": "dry_run",
      "prerequisite_summary_path": "artifacts/calibration/capes_ci_qptm_r14_dryrun_20260723_v1/summary.json",
      "prerequisite_summary_status": "DRY_RUN_VALIDATED_R14",
      "prerequisite_audit_path": "artifacts/calibration/capes_ci_qptm_r14_dryrun_20260723_v1/postrun_audit.json",
      "prerequisite_audit_schema_version": "r14_dryrun_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R14_DRY_RUN_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R14_SMOKE",
    ...
    "smoke_postrun_audit_contract": {
      "schema_version": "r14_smoke_postrun_audit_v1",
      "materializer_id": "smoke_postrun_auditor",
      "self_hash_field": "audit_sha256",
      "self_hash_rule": "sha256_of_canonical_audit_after_removing_only_top_level_audit_sha256",
      "required_exact_top_level_keys": [
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R14_SMOKE_POSTRUN_AUDIT",
        "fail": "FAIL_R14_SMOKE_POSTRUN_AUDIT"
      }
    },
    "registered_authorization": {
      "schema_version": "r14_registered_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r14_phase_authorizations/registered_authorization.json",
      "certificate_type": "registered_authorization",
      "target_phase": "registered_local",
      "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r14_registered_local_20260723_v1",
      "prerequisite_phase": "smoke",
      "prerequisite_summary_path": "artifacts/calibration/capes_ci_qptm_r14_smoke_seed17_20260723_v1/summary.json",
      "prerequisite_summary_status": "SMOKE_COMPLETE_R14_NON_GATING",
      "prerequisite_audit_path": "artifacts/calibration/capes_ci_qptm_r14_smoke_seed17_20260723_v1/postrun_audit.json",
      "prerequisite_audit_schema_version": "r14_smoke_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R14_SMOKE_POSTRUN_AUDIT",
      "prerequisite_audit_self_hash_field": "audit_sha256",
      "prerequisite_audit_self_hash_rule": "sha256_of_canonical_audit_after_removing_only_top_level_audit_sha256",
      "target_seeds": [
        17,
      ...
      "authorization_status": "AUTHORIZED_R14_REGISTERED_LOCAL",
  ...
  "r14_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R14_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R14_DRY_RUN",
    "candidate_status": "PRE_FREEZE_AWAITING_R14_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R14_DRY_RUN",
    "freeze_boolean_json_pointers": [
      "/freeze_requirements/implementation_hashes_frozen",
      "/freeze_requirements/dry_run_authorized"
    ]
  },
  "r13_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R14_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R14_DRY_RUN",
    "candidate_status": "PRE_FREEZE_AWAITING_R14_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R14_DRY_RUN",
...
exact fresh R14 dry-run root is allowed without a reproduction certificate or
...
survival logic, formal boundary, or claim flag changes here. R14 remains E1
...
terminated; R14 never authorizes `scancel 4161`.

## 5. Frozen validation

The one-shot finalizer captured the exact frozen R11 base, all closed R14 source
...
## R14 correction boundary

R14 is a fresh dry-run-to-smoke authorization correction. It does not retrofit R12, authorize registered training, data/model downloads, GPU, Slurm, or allocation 4161. The only new external materializer is the frozen R14 dry-run auditor, which may issue one smoke certificate only after a fresh R14 dry-run postrun audit passes.


## R14 correction boundary

R14 is a fresh local authorization chain: dry-run, independently-audited smoke, then certificate-authorized CPU three-seed registered local execution. It does not authorize reproduction, GPU, Slurm 4161, data/model downloads, formal data, or formal testing.
