# CAPES-CI QPTM R20 Launcher-Owned Issuer Protocol Frozen

Status: `FROZEN_BEFORE_R20_REPRODUCTION`
Date: 2026-07-23
Protocol ID: `CAPES_CI_QPTM_R20_2026_07_23`
Evidence class: `E1_SYNTHETIC_ENGINEERING_NONCONFIRMATORY`

## 1. Authority, evidence, and frozen boundary

This document is the sole **frozen** authority for R20. It derives
from the exact frozen R19 protocol and complete registry pinned below. Runtime
code must read this first JSON object directly and must not recursively merge
R19. Before one-shot finalization, R20 cannot issue an audit or certificate,
consume a claim, create an output root, access data, or support a method,
server, or scientific inference.

## 2. Machine-readable complete frozen registry

```json
{
  "protocol_id": "CAPES_CI_QPTM_R20_2026_07_23",
  "authority_state": "FROZEN_BEFORE_R20_REPRODUCTION",
  ...
  "base_dependency": {
    ...
    "registry_sha256_semantics": "r19_full_canonical_registry_including_complete_freeze_record",
    "authority_state": "FROZEN_BEFORE_R19_REPRODUCTION"
  },
  ...
  "schema_versions": {
    "resolver": "r20_resolver_v1",
    "summary": "r20_summary_v1",
    "runtime_environment": "r6_runtime_environment_v1",
    "source_manifest": "r20_closed_source_manifest_v1",
    "result": "r6.result.v1",
    "initialization": "r20_initialization_evidence_v1",
    ...
    "reproduction": "r20_reproduction_certificate_v1",
    "failure": "r20_atomic_failure_v1",
    "freeze_record": "r20_freeze_record_v1",
    "dryrun_postrun_audit": "r20_dryrun_postrun_audit_v1",
    "smoke_authorization": "r20_smoke_authorization_certificate_v1",
    "smoke_postrun_audit": "r20_smoke_postrun_audit_v1",
    "registered_authorization": "r20_registered_authorization_certificate_v1"
  },
  "output_root_contract": {
    ...
    "phase_leaf_names": {
      "dry_run": "capes_ci_qptm_r20_dryrun_20260723_v1",
      "smoke": "capes_ci_qptm_r20_smoke_seed17_20260723_v1",
      "registered_local": "capes_ci_qptm_r20_registered_local_20260723_v1",
      "registered_slurm4161": "capes_ci_qptm_r20_registered_slurm4161_20260723_v1",
      "reproduction_local": "capes_ci_qptm_r20_reproduction_local_20260723_v1",
      "reproduction_slurm4161": "capes_ci_qptm_r20_reproduction_slurm4161_20260723_v1"
    },
  ...
  "status_vocabulary": {
    "protocol_candidate": "PRE_FREEZE_AWAITING_R20_IMPLEMENTATION_HASHES",
    "protocol_frozen": "FROZEN_BEFORE_R20_REPRODUCTION",
    ...
    "dry_run_success": "DRY_RUN_VALIDATED_R20",
    "smoke_authorized": "AUTHORIZED_R20_SMOKE",
    "smoke_success": "SMOKE_COMPLETE_R20_NON_GATING",
    "registered_local_authorized": "AUTHORIZED_R20_REGISTERED_LOCAL",
    "primary_pending_reproduction": "PASS_R14_GATES_0_TO_7_AWAITING_INDEPENDENT_REPRODUCTION",
    "final_success": "PASS_R20_SYNTHETIC_ENGINEERING",
    "scientific_stop_prefix": "STOP_R20_",
    "technical_failure": "TECHNICAL_FAILURE_R20_UNHANDLED_EXCEPTION",
    "launcher_failure": "TECHNICAL_FAILURE_R20_REPRODUCTION_LAUNCHER",
    "phase_authorization_failure": "TECHNICAL_FAILURE_R20_PHASE_AUTHORIZATION",
    "formal_data": "HOLD",
    "formal_test": "SEALED"
  },
  "gate_order": [
  ...
  "implementation_observation_expected": {
    ...
    "source_hashes": {
      ...
      "scripts/run_query_anchor_r4.py": "964ce067a91cfc87141a5acc755b9f852d283c19d987b9576b1db7a7622d69b1",
      "scripts/run_query_anchor_r4_reproduction.py": "2e9588f90f483b1f4efd35884c8649b9829ab79c8be9a565116b1ada1f451635",
      ...
      "src/visualvit/r6_validation.py": "fd10a120b61bb72f2a83bd67e67b2c718af9cf7041d1260c7e02c5d567691f00",
      ...
      "tests/test_query_anchor_r4_runner.py": "39a2306d67c3f47e6ffc5f3b46966b5f7bff884add9f54579f3b769f239b92d2",
      ...
      "tests/test_r6_reproduction.py": "dc8b3331a9527af823d6e2e9842cc2f34ca7e563d8e3521778ed346ed6f62260",
      ...
      "tests/test_r6_validation.py": "a91b153e53a70fa31c617ef304b49bebc1401673d77c13e7f6b1bada6a77c8ce",
  ...
  "atomic_failure_contract": {
    ...
    "pre_output_root_failure_parent": "artifacts/calibration/.r20_pre_root_failures",
  ...
  "closed_source_allowlist_contract": {
    ...
    "paths": [
      "pyproject.toml",
      "refine-logs/CALIBRATION_PROTOCOL_R20_2026-07-23.md",
  ...
  "freeze_record": {
    "schema_version": "r20_freeze_record_v1",
    "canonicalization": "utf8_json_sort_keys_compact_ascii_no_nan_v1",
    "registry_projection_excluded_json_pointers": [
      "/freeze_record"
    ],
    ...
    "protocol_candidate_sha256": "ef9f0ce1e761783669911d1ec358fc59730a933ca24e4dd4bb5388662f28c671",
    "implementation_observation_sha256": "80004e5ec7d7b58a5ff38625e7cafeafe4b942809976e80560597f0c8ac6e8d8",
    "runner_sha256": "964ce067a91cfc87141a5acc755b9f852d283c19d987b9576b1db7a7622d69b1",
    "reproduction_launcher_sha256": "2e9588f90f483b1f4efd35884c8649b9829ab79c8be9a565116b1ada1f451635",
    ...
    "runner_tests_sha256": "39a2306d67c3f47e6ffc5f3b46966b5f7bff884add9f54579f3b769f239b92d2",
    ...
    "semantic_validator_sha256": "fd10a120b61bb72f2a83bd67e67b2c718af9cf7041d1260c7e02c5d567691f00",
    "semantic_validator_tests_sha256": "a91b153e53a70fa31c617ef304b49bebc1401673d77c13e7f6b1bada6a77c8ce",
    "boundary_tests_sha256": "60c895940d0f34927f44b6e1774244aba53c0d8c3ffe8fc39a05ddcc6daa39f2",
    "reproduction_tests_sha256": "dc8b3331a9527af823d6e2e9842cc2f34ca7e563d8e3521778ed346ed6f62260",
    "gate_spec_sha256": "9ee58dd2053816d216bc5ed8d339fb4bb4488c092fccd090cd05bcbccd385715",
    "closed_manifest_sha256": "1b6a928c1ac0fac983e16722f18e8eb9dc58eb6a668c37d91ab9ce0a8ed802c1",
    "canonical_registry_sha256": "414dcc17af242e469143c060723d07fe70afc115fd846e3d0f2fb9c5fd2d4887",
  ...
  "corrective_scope": {
    "r20_administrative_deltas": [
      "require_active_runner_to_be_natively_R20_before_finalization",
      "require_launcher_owned_synchronous_exactly_once_issuer_transaction",
      "require_absent_parent_and_fresh_r20_authority_namespace_precheck",
      "forbid_preissued_r20_audit_or_child_certificates",
      "forbid_issuer_retry",
      "require_both_certificates_reopened_before_parent_creation"
    ],
    "no_scientific_method_or_data_delta": true,
    "r19_passing_audit_and_preissued_child_certificates_preserved_as_immutable_ineligible_forensic_evidence": true,
    "r19_protocol_and_full_canonical_registry_pins_immutable": true,
    "r18_prefinalization_runner_mismatch_preserved_as_immutable_forensic_evidence": true,
    "r17_incomplete_freeze_record_preserved_as_immutable_forensic_evidence": true,
    "r16_failed_audit_preserved_as_immutable_forensic_evidence": true,
    "r14_v5_frozen_validator_bundle_and_all_R14_pins_unchanged": true,
    "fresh_r20_phase_audit_certificate_claim_failure_and_reproduction_namespaces_only": true,
    "no_prior_auditor_test_or_prior_protocol_artifact_rewrite": true,
    "new_r20_auditor_and_r20_tests_allowed": true,
    "runner_change_limited_to_native_r20_authority_and_namespace_activation": true,
    ...
    "smoke_seed17": {
      ...
      "diagnostic_boundary": {
        "may_support": [
          ...
          "define_the_single_r20_technical_semantic_correction",
  ...
  "phase_authorization_contract": {
    "schema_version": "r20_phase_authorization_contract_v1",
    "external_materializers": {
      "registered_reproduction_authorizer": {
        "relative_path": ".tmp/audit_r20_registered.py",
        "sha256": "6ed454a7877494e42b5157e5fda335652f41b9466369e656af5d87d139c1a26d",
    ...
    "authorization_root_relative": "artifacts/calibration/.r20_phase_authorizations",
    ...
    "source_manifest_hash_rule": "certificate_source_manifest_sha256_equals_runner__source_manifest_sha256_over_the_full_live_manifest_including_protocol_and_observed_workspace_imports_distinct_from_freeze_record_closed_manifest_sha256",
    ...
    "claims_subdirectory_relative": "artifacts/calibration/.r20_phase_authorizations/claims",
    "claim_schema_version": "r20_phase_authorization_claim_v1",
    ...
    "runner_guard": {
      ...
      "authorization_denial_status": "TECHNICAL_FAILURE_R20_PHASE_AUTHORIZATION",
      "denial_uses_pre_root_failure_parent": "artifacts/calibration/.r20_pre_root_failures",
    ...
    "registered_postrun_audit_contract": {
      "schema_version": "r20_registered_postrun_audit_v1",
      ...
      "relative_path": "artifacts/calibration/.r20_phase_authorizations/r14_registered_local_postrun_audit.json",
      ...
      "required_exact_verdicts": {
        "pass": "PASS_R20_REGISTERED_POSTRUN_AUDIT",
        "fail": "FAIL_R20_REGISTERED_POSTRUN_AUDIT"
      }
    },
    "reproduction_authorization": {
      ...
      "issuer_invocation": {
        ...
        "preissued_r20_audit_or_child_certificates_forbidden": true,
      ...
      "target_output_parent_relative": "artifacts/calibration/capes_ci_qptm_r20_reproduction_local_20260723_v1",
      ...
      "child_certificates": {
        "process_a": {
          "schema_version": "r20_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_a_authorization",
          "relative_path": "artifacts/calibration/.r20_phase_authorizations/reproduction_process_a_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r20_reproduction_local_20260723_v1/process_a"
        },
        "process_b": {
          "schema_version": "r20_reproduction_child_authorization_certificate_v1",
          "certificate_type": "reproduction_process_b_authorization",
          "relative_path": "artifacts/calibration/.r20_phase_authorizations/reproduction_process_b_authorization.json",
          "target_output_root_relative": "artifacts/calibration/capes_ci_qptm_r20_reproduction_local_20260723_v1/process_b"
        }
      },
      ...
      "prerequisite_audit_path": "artifacts/calibration/.r20_phase_authorizations/r14_registered_local_postrun_audit.json",
      "prerequisite_audit_schema_version": "r20_registered_postrun_audit_v1",
      "prerequisite_audit_verdict": "PASS_R20_REGISTERED_POSTRUN_AUDIT",
      ...
      "authorization_status": "AUTHORIZED_R20_INDEPENDENT_REPRODUCTION",
      ...
      "child_certificate_required_exact_check_keys": [
        ...
        "full_source_manifest_hash_matches_live",
      ...
      "schema_version": "r20_reproduction_authorization_certificate_v1",
      "relative_path": "artifacts/calibration/.r20_phase_authorizations/reproduction_authorization.json",
      "launcher_owned_issuer_transaction_contract": {
        ...
        "synchronous": true,
        "retry_allowed": false,
        "preissued_r20_audit_allowed": false,
        "preissued_r20_child_certificates_allowed": false,
        "required_precheck_order": [
          "target_output_parent_absent",
          "r20_authority_namespace_absent",
          "r20_registered_audit_absent",
          "r20_process_a_certificate_absent",
          "r20_process_b_certificate_absent"
        ],
        ...
        "r19_authority_namespace_is_forensic_only_and_never_read_as_r20_authority": true
      }
    },
    "freeze_preconditions": {
      "authority_state_must_be_frozen_before_issuer_or_runner": "FROZEN_BEFORE_R20_REPRODUCTION",
    ...
    "safe_path_transaction_contract": {
      ...
      "reparse_or_identity_change_response": "abort pre-root with TECHNICAL_FAILURE_R20_PHASE_AUTHORIZATION and create no affected child output root",
    ...
    "r14_provenance_comparator_routing": {
      "schema_version": "r20_r14_provenance_comparator_routing_v1",
  ...
  "r20_pre_finalization_runner_contract": {
    "required_before_finalizer_import_or_implementation_observation": true,
    "runner_must_natively_load_protocol_relative_path": "refine-logs/CALIBRATION_PROTOCOL_R20_2026-07-23.md",
    "runner_must_natively_expose_protocol_id": "CAPES_CI_QPTM_R20_2026_07_23",
    "runner_must_natively_expose_registry_object": true,
    "runner_must_natively_expose_r20_schema_and_run_namespaces": true,
  ...
  "r20_launcher_owned_issuer_transaction_contract": {
    "transaction_owner": "scripts/run_query_anchor_r4_reproduction.py",
    "issuer_invocation_count_exact": 1,
    "synchronous": true,
    "retry_allowed": false,
  ...
  "r20_finalization_contract": {
    "candidate_authority_state": "PRE_FREEZE_AWAITING_R20_IMPLEMENTATION_HASHES",
    "frozen_authority_state": "FROZEN_BEFORE_R20_REPRODUCTION",
    "candidate_status": "PRE_FREEZE_AWAITING_R20_IMPLEMENTATION_HASHES",
    "frozen_status": "FROZEN_BEFORE_R20_REPRODUCTION",
    ...
    "freeze_record_semantics": "r20_complete_nonself_final_protocol_projection_contract_v1",
    ...
    "certificate_source_manifest_sha256_semantics": "runner_source_manifest_sha256_over_full_live_allowlist_files_and_observed_workspace_imports_including_protocol",
    "closed_manifest_sha256_must_not_equal_or_substitute_for_certificate_source_manifest_sha256": true,
    "final_prose_transition": {
      "section_heading_from": "## 3. Candidate execution boundary",
      "section_heading_to": "## 3. Frozen execution boundary",
      "pre_freeze_prohibition_becomes_historical": true,
      "frozen_execution_remains_certificate_and_claim_gated": true,
      "dry_run_smoke_registered_local_gpu_slurm_download_formal_paths_remain_unauthorized": true
    },
    "native_runner_precondition_ref": "/r20_pre_finalization_runner_contract"
  }
}
```
...
R20 is frozen before independent reproduction: implementation hashes are frozen, `dry_run_authorized=false` remains unchanged, and freeze alone authorizes no execution. The PRE_FREEZE prohibition applied until this one-shot finalization completed. Independent reproduction remains gated by the launcher's synchronous exactly-once no-retry issuer transaction, fresh R20 audit, two fresh R20 child certificates, claims, and runner verification in this authority; preissued R20 authority remains forbidden. Dry-run, smoke, registered-local, GPU, Slurm/4161, download, formal-data, and formal-test paths remain unauthorized.

R20 makes one execution-control correction. The reproduction launcher owns the
issuer transaction. After it proves the R20 output parent, R20 authority
namespace, R20 registered audit, and both R20 child-certificate paths absent,
it invokes the frozen R20 issuer synchronously exactly once. Retry is forbidden.
The issuer must succeed and the launcher must reopen both exact certificates
before creating the reproduction parent. A preissued R20 audit or child
certificate is terminally ineligible; no preissued authority is a dependency.

## 4. Scientific invariance and forensic boundary

This is an administrative integrity delta only. R20 changes no scientific method, architecture, objective, fixture, threshold, seed, split, optimizer setting, registered step count, gate order, survival logic, formal boundary, claim flag, data contract, or two-child routing. The passing R19 registered audit and both preissued R19 child certificates remain byte-pinned, immutable, ineligible forensic evidence. They cannot be moved, copied, consumed, or read as R20 authority. The earlier R16, R17, and R18 evidence is likewise retained without rewrite. Dataset/model downloads, real-image training, clinical claims, formal-test reveal, formal main experiments, and formal ablations remain HOLD or SEALED.

The frozen R14 v5 validator bundle and every R14 pin are retained unchanged. Retained allocation `4161 / tpami / gpu01` must not be cancelled, released, or terminated; R20 never authorizes `scancel 4161`.

## 5. R20 independent-reproduction boundary

R20 registers fresh `.r20_phase_authorizations`, R20 audit, child-certificate,
claim, failure, and reproduction-root paths only. The launcher-owned transaction
is the sole route to R20 issuer execution. Dry-run, smoke, registered-local,
GPU, Slurm/4161, download, formal-data, and formal-test paths are registered
only for fail-closed rejection; none is authorized by R20.
